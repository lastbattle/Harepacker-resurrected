        ...
        public static unsafe uint GetCrc32(byte* val, uint length, uint initialCrc, bool flag1, ref uint a5, bool flag2) {
            ...
            if (length >= 0x10) {
                ...
                do {
                    ...
                    uint v13 = *++v11 ^ (v12 >> 24);
                    int v14 = v11[1];
                    uint v15 = CCrc32.ms_adwCrc32Table[v13] ^ (v12 << 8);
                    ++v11;
                    long v16 = v14 ^ (v15 >> 24);
                    int v17 = v11[1];
                    uint v18 = CCrc32.ms_adwCrc32Table[v16] ^ (v15 << 8);
                    ++v11;
                    long v19 = v17 ^ (v18 >> 24);
                    int v20 = v11[1];
                    uint v21 = CCrc32.ms_adwCrc32Table[v19] ^ (v18 << 8);
                    ++v11;
                    long v22 = v20 ^ (v21 >> 24);
                    int v23 = v11[1];
                    uint v24 = CCrc32.ms_adwCrc32Table[v22] ^ (v21 << 8);
                    ++v11;
                    long v25 = v23 ^ (v24 >> 24);
                    int v26 = v11[1];
                    uint v27 = CCrc32.ms_adwCrc32Table[v25] ^ (v24 << 8);
                    ++v11;
                    long v28 = v26 ^ (v27 >> 24);
                    int v29 = v11[1];
                    uint v30 = CCrc32.ms_adwCrc32Table[v28] ^ (v27 << 8);
                    ++v11;
                    long v31 = v29 ^ (v30 >> 24);
                    int v32 = v11[1];
                    uint v33 = CCrc32.ms_adwCrc32Table[v31] ^ (v30 << 8);
                    ++v11;
                    long v34 = v32 ^ (v33 >> 24);
                    int v35 = v11[1];
                    uint v36 = CCrc32.ms_adwCrc32Table[v34] ^ (v33 << 8);
                    ++v11;
                    long v37 = v35 ^ (v36 >> 24);
                    int v38 = v11[1];
                    uint v39 = CCrc32.ms_adwCrc32Table[v37] ^ (v36 << 8);
                    ++v11;
                    long v40 = v38 ^ (v39 >> 24);
                    int v41 = v11[1];
                    uint v42 = CCrc32.ms_adwCrc32Table[v40] ^ (v39 << 8);
                    ++v11;
                    long v43 = v41 ^ (v42 >> 24);
                    int v44 = v11[1];
                    uint v45 = CCrc32.ms_adwCrc32Table[v43] ^ (v42 << 8);
                    ++v11;
