...
namespace HaCreator.MapSimulator
{
    public partial class MapSimulator
    {
        ...
        private ReviveOwnerVariant ResolveReviveOwnerVariant()
        {
            ...
            bool fieldAllowsCurrentFieldRecovery = IsPremiumCurrentFieldReviveUsable(_mapInfo);
            ...
            Vector2 fallbackPoint)
        {
            ...
            return ResolveCurrentFieldReviveRespawnPointWithSource(_mapInfo, spawnPoint, fallbackPoint);
        }
        ...
        private string BuildDefaultReviveDetail(ReviveOwnerVariant variant, string ownerLabel, Vector2 spawnPoint)
        {
        ...
        private string BuildPremiumReviveDetail(
            ReviveOwnerVariant variant,
            string ownerLabel,
        ...
        private string ResolveReviveOwnerDetailPrefix(ReviveOwnerVariant variant, string ownerLabel)
        {
            ...
            bool hasName = InventoryItemMetadataResolver.TryResolveItemName(cashItemId, runtimeServices.Catalog, out string resolvedName)
                && !string.IsNullOrWhiteSpace(resolvedName);
            bool hasDescription = InventoryItemMetadataResolver.TryResolveItemDescription(cashItemId, runtimeServices.Catalog, out string resolvedDescription)
        ...
        private bool TryResolveReviveOwnerSkillText(
            int skillId,
            out string skillName,
            out string skillDescription,
            out string skillHint)
        {
            ...
            WzImage skillStringImage = runtimeServices.Assets.FindImage("String", "Skill.img");
