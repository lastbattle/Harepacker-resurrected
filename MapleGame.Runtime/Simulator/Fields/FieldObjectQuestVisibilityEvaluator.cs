...
namespace HaCreator.MapSimulator.Fields
{
    ...
    {
        public static bool IsVisible(bool hiddenByMap, IReadOnlyList<RuntimeObjectQuestDefinition> questInfo, Func<int, QuestStateType> getQuestState)
        {
        ...
        public static bool IsVisible(
            bool hiddenByMap,
            IReadOnlyList<RuntimeObjectQuestDefinition> questInfo,
        ...
        public static bool IsVisible(IReadOnlyList<RuntimeObjectQuestDefinition> questInfo, Func<int, QuestStateType> getQuestState)
        {
        ...
        private static bool MatchesQuestState(IReadOnlyList<RuntimeObjectQuestDefinition> questInfo, Func<int, QuestStateType> getQuestState)
        {
            ...
            {
                RuntimeObjectQuestDefinition requirement = questInfo[i];
                if ((int)getQuestState(requirement.QuestId) == requirement.State)
                {
                    return true;
                }
            }
