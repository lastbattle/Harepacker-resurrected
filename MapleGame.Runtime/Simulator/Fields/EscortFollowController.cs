...
namespace HaCreator.MapSimulator.Fields
{
    ...
    public sealed class EscortFollowController
    {
            ...
            int updateToken = 0)
        {
            ...
            RuntimeFoothold playerFoothold = ResolvePlayerFoothold(player, attached);
        ...
        private static bool CanEvaluate(
            PlayerCharacter player,
            RuntimeFoothold playerFoothold,
            MobMovementInfo movement,
            bool movementLocked,
            bool attached)
        {
        ...
        private static RuntimeFoothold ResolvePlayerFoothold(PlayerCharacter player, bool allowAirborneCarry)
        {
            ...
            RuntimeFoothold fallStartFoothold = player.Physics.FallStartFoothold;
            return IsWithinFootholdCarryWindow(fallStartFoothold, player.X)
                ? fallStartFoothold
                : null;
        }

        private static float ResolvePlayerFollowY(PlayerCharacter player, RuntimeFoothold playerFoothold, bool allowAirborneCarry)
        {
            if (player?.Physics == null
                || playerFoothold == null
        ...
        private static bool IsWithinFootholdCarryWindow(RuntimeFoothold foothold, float x)
        {
            if (foothold == null)
            {
                return false;
        ...
        public static bool CanTraverseBetween(RuntimeFoothold start, RuntimeFoothold target)
        {
            ...
            var visited = new HashSet<RuntimeFoothold>();
            var queue = new Queue<RuntimeFoothold>();
            ...
            {
                RuntimeFoothold foothold = queue.Dequeue();
                ...
                EnqueueConnectedFootholds(foothold.FirstDot, target, visited, queue);
                EnqueueConnectedFootholds(foothold.SecondDot, target, visited, queue);
            }
        ...
        private static void EnqueueConnectedFootholds(
            RuntimeFootholdAnchor anchor,
            RuntimeFoothold target,
            HashSet<RuntimeFoothold> visited,
            Queue<RuntimeFoothold> queue)
        {
            ...
            foreach (RuntimeFoothold foothold in anchor.ConnectedLines)
            {
                if (foothold.IsWall || !visited.Add(foothold))
                {
                    continue;
                }
        ...
        private static float GetMidpointY(RuntimeFoothold foothold)
        {
