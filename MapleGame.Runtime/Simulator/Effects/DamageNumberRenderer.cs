...
namespace HaCreator.MapSimulator.Effects
{
    ...
    {
        private readonly DamageNumberLoader damageNumberLoader;

        public DamageNumberRenderer(DamageNumberLoader damageNumberLoader)
        {
            this.damageNumberLoader = damageNumberLoader ?? throw new ArgumentNullException(nameof(damageNumberLoader));
        }
        ...
        private PreparedDamageNumberVisual PrepareVisual(WzDamageNumber dmgNumber)
        {
            DamageNumberDigitSet largeDigitSet = ResolveLargeDigitSet(dmgNumber.ColorType, dmgNumber.IsCritical);
            DamageNumberDigitSet smallDigitSet = ResolveSmallDigitSet(dmgNumber.ColorType, dmgNumber.IsCritical);
            ...
            return PrepareVisual(
                ...
                dmgNumber.SpecialTextName,
                largeDigitSet,
                smallDigitSet, ResolveSpecialTextDigitSet());
        }
        ...
        internal static PreparedDamageNumberVisual PrepareVisual(
            ...
            DamageNumberDigitSet largeDigitSet,
            DamageNumberDigitSet smallDigitSet,
            DamageNumberDigitSet specialTextDigitSet)
        {
            return PrepareVisual(
                damage,
                colorType,
                ...
                largeDigitSet,
                smallDigitSet, specialTextDigitSet);
        }
        ...
        private DamageNumberDigitSet ResolveSpecialTextDigitSet()
        {
        ...
        private DamageNumberDigitSet ResolveLargeDigitSet(DamageColorType colorType, bool isCritical)
        {
            string setName = ResolveLargeDigitSetName(colorType, isCritical);
            return ResolveDigitSetByName(setName);
        }

        private DamageNumberDigitSet ResolveSmallDigitSet(DamageColorType colorType, bool isCritical)
        {
        ...
        private DamageNumberDigitSet ResolveDigitSetByName(string setName)
        {
