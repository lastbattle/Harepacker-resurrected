...
namespace HaCreator.MapSimulator.Effects
{
    ...
    public class CombatEffects
    {
        ...
        private readonly DamageNumberLoader damageNumberLoader = new();
        ...
        public bool LoadDamageNumbersFromWz(WzImage basicEffImage)
        {
            ...
            _wzDamageRenderer = null;
            _useWzDamageNumbers = false;
            ...
            if (loaded)
            {
                ...
                _wzDamageRenderer = new DamageNumberRenderer(damageNumberLoader);
        ...
        private void AddBossHPBar(MobItem boss, int currentTime)
        {
            ...
            var mobData = boss.MobData;
            if (mobData == null || mobData.HpTagColor <= 0)
                return;

            // Get boss name from mob instance
            string bossName = boss.RuntimeLife?.DisplayName ?? "Boss";
