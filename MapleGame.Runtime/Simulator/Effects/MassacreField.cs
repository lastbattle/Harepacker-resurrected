...
namespace HaCreator.MapSimulator.Effects
{
    ...
    public class MassacreField
    {
        ...
        private void EnsureAssetsLoaded()
        {
            ...
            {
                WzImage uiImage = _runtimeServices?.Assets?.FindImage("UI", imageName);
        ...
        private WzImageProperty FindPropertyByResourcePath(int stringPoolId, string fallbackPath)
        {
        ...
        private WzImageProperty ResolveClientResourcePath(string resourcePath)
        {
            ...
            {
                WzImage image = _runtimeServices?.Assets?.FindImage(category, candidateImageName);
                if (image == null)
                {
                    continue;
                }
