...
namespace HaCreator.MapSimulator.Effects
{
    ...
    public sealed class CakePieEventField
    {
        ...
        public void Initialize(GraphicsDevice graphicsDevice, IRuntimeDataServices runtimeServices = null)
        {
        ...
        private void EnsureAssetsLoaded()
        {
            ...
            WzImage objImage = _runtimeServices?.Assets?.FindImage("Map", "Obj/etc.img")
                ?? _runtimeServices?.Assets?.FindImage("Map", "etc.img");
            WzImage uiWindowImage = _runtimeServices?.Assets?.FindImage("UI", "UIWindow.img")
