...
namespace HaCreator.MapSimulator.Character.Skills
{
    internal static class PreparedSkillHudRules
    {
        ...
        public static bool IsSupportedKeyDownSkill(int skillId, IRuntimeAssetSource assets = null)
        {
            ...
            return SupportedKeyDownSkillIds.Contains(skillId)
                || HasAuthoredKeydownNode(skillId, assets);
        }

        public static bool ResolveKeyDownSkillState(
            int skillId,
            bool isKeydownSkill,
            IRuntimeAssetSource assets = null)
        {
            ...
            return isKeydownSkill
                ...
                || IsSupportedKeyDownSkill(skillId, assets);
        }
        ...
        public static int ResolveGaugeDuration(
            int skillId,
            int authoredDurationMs = 0,
            bool isKeydownSkill = false,
            IRuntimeAssetSource assets = null)
        {
            PreparedSkillHudProfile profile = ResolveProfile(skillId);
            bool resolvedAsKeyDownSkill = ResolveKeyDownSkillState(skillId, isKeydownSkill, assets);
            ...
            return skillId == MonkeyWaveSkillId
                ? ResolveMonkeyWaveGaugeDuration(assets)
                : 0;
        }
            ...
            IRuntimeAssetSource assets = null)
        {
            ...
            {
                return ResolveMonkeyWaveGaugeDuration(assets);
            }
            ...
            return ResolveGaugeDuration(skillId, isKeydownSkill: isKeydownSkill, assets: assets);
        }
        ...
        public static int ResolveReleaseChargeElapsedMs(
            int skillId,
            int elapsedMs,
            ...
            IRuntimeAssetSource assets = null)
        {
            ...
            int normalizedGaugeDurationMs = gaugeDurationMs > 0
                ? gaugeDurationMs
                : ResolveGaugeDuration(skillId, assets: assets);
        ...
        public static bool CanExecuteReleasePayload(
            int skillId,
            int elapsedMs,
            int gaugeDurationMs = 0,
            IRuntimeAssetSource assets = null)
        {
            int normalizedElapsedMs = ResolveReleaseChargeElapsedMs(skillId, elapsedMs, gaugeDurationMs, assets);
            ...
            IRuntimeAssetSource assets = null)
        {
            ...
            bool normalizedIsKeydownSkill = ResolveKeyDownSkillState(skillId, isKeydownSkill, assets);
        ...
        internal static bool HasAuthoredKeydownNode(int skillId, IRuntimeAssetSource assets = null)
        {
            if (skillId <= 0)
            {
                return false;
            ...
            try
            {
                ...
                WzImage image = jobId > 0
                    ? assets?.FindImage("Skill", $"{jobId}.img")
                    : null;
                if (image != null)
                {
                    if (!image.Parsed)
        ...
        internal static int ResolveMonkeyWaveGaugeDuration(IRuntimeAssetSource assets = null)
        {
            int resolvedDuration = MonkeyWaveFallbackGaugeDurationMs;
            try
            {
                WzImage image = assets?.FindImage("Skill", "531.img");
