...
namespace HaCreator.MapSimulator.Character
{
    ...
    public class PlayerManager
    {
        ...
        private Func<float, float, float, RuntimeFoothold> _findFoothold;
        private Func<float, float, float, RuntimeFoothold> _findFootholdUnderneath;
        private Func<float, float, float, RuntimeFoothold> _findFootholdAbove;
            ...
            ISimulatorProfileStorage profileStorage = null)
        {
            ...
            Config = new CharacterConfigManager(profileStorage: profileStorage);
            Pets = new PetController(device, runtimeServices);
            Dragon = new DragonCompanionRuntime(device, runtimeServices);
            CompanionEquipment = new CompanionEquipmentController(device, runtimeServices);
            ConfigureDragonOwnerPhaseContextProvider();
            ConfigureDragonClientKeyPadStateProvider();
        }

        /// <summary>
        /// Initialize with Character.wz (can be null - the session asset source is used)
        /// </summary>
        ...
        public void Initialize(WzFile characterWz, WzFile skillWz)
        {
            ...
            Loader = new CharacterLoader(characterWz, _device, _texturePool, _runtimeServices);
            System.Diagnostics.Debug.WriteLine($"[PlayerManager] CharacterLoader created");

            SkillLoader = new SkillLoader(skillWz, _device, _texturePool, _runtimeServices.Assets);
            System.Diagnostics.Debug.WriteLine($"[PlayerManager] SkillLoader created");

            _mobSkillEffectLoader = new MobSkillEffectLoader(_device, _texturePool, _runtimeServices.Assets);
        ...
        /// </summary>
        public void SetFootholdLookup(Func<float, float, float, RuntimeFoothold> findFoothold)
        {
        ...
        public void SetClientSummonMonsterFootholdLookups(
            Func<float, float, float, RuntimeFoothold> findFootholdUnderneath,
            Func<float, float, float, RuntimeFoothold> findFootholdAbove)
        {
        ...
        /// </summary>
        public Func<float, float, float, RuntimeFoothold> GetFootholdLookup() => _findFoothold;
        ...
        internal WzBinaryProperty ResolveClientOwnedWeaponSfx(string sfx)
        {
            ...
            _weaponSoundImage ??= _runtimeServices.Assets.FindImage("Sound", "Weapon.img");
        ...
        public void CreatePlayerFromBuild(CharacterBuild build)
        {
            ...
            InitializePlayer(new PlayerCharacter(_device, _texturePool, build, _runtimeServices.Assets));
            ...
            if (SkillLoader != null)
            {
                ...
                Skills = new SkillManager(SkillLoader, Player, _runtimeServices.Assets);
        ...
        private int? ResolveDragonActionLayerOwnerZFromVecCtrlContext(Vector2 dragonAnchor)
        {
            ...
            {
                RuntimeFoothold dragonFoothold = _findFoothold(dragonAnchor.X, dragonAnchor.Y, DragonVecCtrlLayerSearchRange);
        ...
        internal static int? ResolveDragonOwnerLayerZFromFoothold(RuntimeFoothold foothold, bool onLadderOrRope)
        {
            if (foothold == null)
            {
                return null;
        ...
        public bool CreatePlaceholderPlayer()
        {
            ...
            InitializePlayer(new PlayerCharacter(_device, _texturePool, null, _runtimeServices.Assets));
        ...
        public void ReconnectToMap(
            Func<float, float, float, RuntimeFoothold> findFoothold,
