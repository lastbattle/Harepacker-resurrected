...
namespace HaCreator.MapSimulator.Character
{
    ...
    internal static class PacketOwnedAvatarEmotionResolver
    {
            ...
            out string error)
        {
            ...
            if (!TryLoadAreaBuffEmotionWeights(areaBuffItemId, assets, out IReadOnlyList<PacketOwnedAvatarEmotionWeight> weightedEmotions, out error))
            {
                return false;
            }
            ...
            out string error)
        {
            ...
            WzSubProperty itemProperty = LoadItemProperty(itemId, assets);
            ...
            {
                return TryResolveRandomEmotion(itemId, randomRoll, assets, out selection, out error);
            }
            ...
            out string error)
        {
            ...
            WzSubProperty itemProperty = LoadItemProperty(areaBuffItemId, assets);
            if (itemProperty == null)
            {
        ...
        private static WzSubProperty LoadItemProperty(int itemId, IRuntimeAssetSource assets)
        {
