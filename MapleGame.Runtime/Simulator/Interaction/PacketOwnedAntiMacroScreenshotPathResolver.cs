...
namespace HaCreator.MapSimulator.Interaction
{
    internal static class PacketOwnedAntiMacroScreenshotPathResolver
    {
        ...
        {
            return ResolveFolderMode(FolderModeClientDirectory);
        }

        internal static int ResolveFolderMode(int configuredMode)
        {
        ...
        {
            return ResolveBaseFolder(FolderModeClientDirectory);
        }

        internal static string ResolveBaseFolder(int configuredMode)
        {
            return ResolveBaseFolder(
                ResolveFolderMode(configuredMode),
