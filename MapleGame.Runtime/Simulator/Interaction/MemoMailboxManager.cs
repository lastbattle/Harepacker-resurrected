...
namespace HaCreator.MapSimulator.Interaction
{
    internal sealed class MemoMailboxManager
    {
        ...
        internal IRuntimeAssetCatalog Catalog => services.Catalog;
        internal MemoMailboxManager(IRuntimeDataServices services)
        {
        ...
        private string BuildAttachmentSummary(MemoAttachmentState attachment)
        {
        ...
        private string ResolvePacketOwnedParcelBody(PacketOwnedParcelDecodedEntry entry)
        {
            if (entry == null)
            {
                return string.Empty;
        ...
        private string BuildAttachmentDescription(MemoState memo)
        {
        ...
        {
            return services.Catalog.TryGetItemName(itemId, out var item) && !string.IsNullOrWhiteSpace(item.Name)
