...
namespace HaCreator.MapSimulator.Interaction
{
    internal sealed class AvatarMegaphoneRuntime
    {
        ...
        internal AvatarMegaphoneRuntime(IRuntimeAssetSource assets)
        {
            ...
            out string message)
        {
            ...
            string filteredChatText = ClientCurseProcessParity.FilterTextForClientDisplay(formattedChatText, assets);
        ...
        private AvatarMegaphoneItemProfile ResolveItemProfile(int itemId)
        {
            ...
            WzImage itemImage = assets.FindImage("Item", "Cash/0539.img") ?? assets.FindImage("Item", "Cash/0539");
        ...
        private WzCanvasProperty ResolveCanvas(string resourcePath)
        {
        ...
        private WzImageProperty ResolveClientResourcePath(string resourcePath)
        {
            ...
            {
                WzImage image = assets.FindImage(category, candidateImageName);
