...
namespace HaCreator.MapSimulator.Interaction
{
    ...
    {
        internal static IReadOnlyDictionary<long, PacketScriptMessageRuntime.PacketScriptPetSelectionCandidate> BuildCandidates(
            ...
            IRuntimeAssetCatalog runtimeCatalog = null)
        {
            ...
            foreach (PacketCharacterDataItemSlot cashItem in cashItems)
            {
                ...
                string displayName = ResolvePetDisplayName(cashItem.ItemId, cashItem.InventoryPosition, runtimeCatalog);
            ...
            IRuntimeAssetCatalog runtimeCatalog = null)
        {
            ...
            for (int i = 0; i < liveCashSlots.Count; i++)
            {
                ...
                string displayName = ResolveLiveInventoryDisplayName(slot.ItemId, slot.ItemName, (short)(i + 1), runtimeCatalog);
        ...
        private static string ResolvePetDisplayName(
            int itemId,
            short inventoryPosition,
            IRuntimeAssetCatalog runtimeCatalog)
        {
            if (runtimeCatalog != null &&
                InventoryItemMetadataResolver.TryResolveItemName(itemId, runtimeCatalog, out string itemName) &&
        ...
        private static string ResolveLiveInventoryDisplayName(
            int itemId,
            string itemName,
            short inventoryPosition,
            IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            return ResolvePetDisplayName(itemId, inventoryPosition, runtimeCatalog);
        }
