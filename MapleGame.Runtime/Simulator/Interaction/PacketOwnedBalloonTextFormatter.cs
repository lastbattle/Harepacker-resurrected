...
namespace HaCreator.MapSimulator.Interaction
{
    ...
    internal static class PacketOwnedBalloonTextFormatter
    {
        ...
        public static string Format(string text, PacketOwnedBalloonTextFormattingContext context = null)
        {
            ...
            formatted = NumericPrefixedStyleRegex.Replace(formatted, match => "#" + match.Groups["tag"].Value);
            formatted = TerminatedInlineStyleRegex.Replace(
                formatted,
                match => "#" + match.Groups["tag"].Value.ToLowerInvariant());
            formatted = InlineStyleBlockRegex.Replace(formatted, match => ExpandInlineStyleBlock(match));
            formatted = MalformedPunctuationTagRegex.Replace(formatted, "${punct}");
            formatted = LiteralPhraseHashRegex.Replace(formatted, match => match.Groups["text"].Value);
        ...
        {
            return InlineSelectionRegex.Replace(text, match => match.Groups["text"].Value);
        }
        ...
        private static string ResolveCurrentMapName(PacketOwnedBalloonTextFormattingContext context)
        {
            return context?.CurrentMapId is int mapId && mapId > 0
                ? ResolveMapName(context, mapId.ToString())
                : "this map";
        }
        ...
        private static string ResolveNpcName(PacketOwnedBalloonTextFormattingContext context, string npcIdText)
        {
        ...
        private static string ResolveItemName(PacketOwnedBalloonTextFormattingContext context, string itemIdText)
        {
        ...
        private static string ResolveQuestName(PacketOwnedBalloonTextFormattingContext context, string questIdText)
        {
        ...
        private static string ResolveSkillName(PacketOwnedBalloonTextFormattingContext context, string skillIdText)
        {
        ...
        private static string ResolveMapName(PacketOwnedBalloonTextFormattingContext context, string mapIdText)
        {
        ...
        private static string ResolveMobName(PacketOwnedBalloonTextFormattingContext context, string mobIdText)
        {
        ...
        private static string ResolveActiveQuestNameText(PacketOwnedBalloonTextFormattingContext context)
        {
            int activeQuestId = context?.ActiveQuestId ?? 0;
            return activeQuestId > 0
                ? ResolveQuestName(context, activeQuestId.ToString(CultureInfo.InvariantCulture))
                : "current quest";
        }
        ...
        private static string ResolveSelectedMobText(PacketOwnedBalloonTextFormattingContext context, string questIdText)
        {
        ...
        private static string ResolveQuestAmountText(PacketOwnedBalloonTextFormattingContext context, string questIdText)
        {
        ...
        private static string ResolveQuestValueText(PacketOwnedBalloonTextFormattingContext context, string questIdText)
        {
            return HasSelectedMobFlag(context, questIdText)
        ...
        private static string ResolveActiveSelectedMobText(PacketOwnedBalloonTextFormattingContext context)
        {
            int activeQuestId = context?.ActiveQuestId ?? 0;
            return activeQuestId > 0
                ? ResolveSelectedMobText(context, activeQuestId.ToString(CultureInfo.InvariantCulture))
                : "the selected monster";
        }
        ...
        private static string ResolveActiveQuestAmountText(PacketOwnedBalloonTextFormattingContext context)
        {
            int activeQuestId = context?.ActiveQuestId ?? 0;
            return activeQuestId > 0
                ? ResolveQuestAmountText(context, activeQuestId.ToString(CultureInfo.InvariantCulture))
                : "the listed amount";
        }
        ...
        private static string ResolveActiveQuestValueText(PacketOwnedBalloonTextFormattingContext context)
        {
            int activeQuestId = context?.ActiveQuestId ?? 0;
            return activeQuestId > 0
                ? ResolveQuestValueText(context, activeQuestId.ToString(CultureInfo.InvariantCulture))
                : "the listed amount";
        }

        private static bool HasSelectedMobFlag(PacketOwnedBalloonTextFormattingContext context, string questIdText)
        {
            return context?.Services?.Assets.FindImage("Quest", "QuestInfo.img")?[questIdText] is WzSubProperty questInfo &&
        ...
        private static bool TryGetQuestMobRequirement(PacketOwnedBalloonTextFormattingContext context, string questIdText, out int mobId, out int count)
        {
        ...
        private static bool TryGetQuestItemRequirement(PacketOwnedBalloonTextFormattingContext context, string questIdText, out int itemId, out int count)
        {
        ...
        private static bool TryGetQuestRequirement(PacketOwnedBalloonTextFormattingContext context, string questIdText, string requirementName, out WzImageProperty requirementProperty)
        {
