...
namespace HaCreator.MapSimulator.Interaction
{
    internal sealed class EngagementProposalRuntime
    {
        ...
        internal const int PrimaryButtonWidth = 41;
        internal const int PrimaryButtonHeight = 18;
        internal const int PrimaryButtonStateCount = 4;
        internal const int FrameWidth = 260;
        internal const int TextTop = 20;
        internal const int TextCenterWidth = 234;
        internal const int ClientTextWrapWidth = 200;
        internal const int TextLeft = 15;
        internal const int TextSlotHeight = 16;
        internal const int TextDrawHeight = 14;
        internal const int CenterBandTop = 20;
        internal const int CenterBandStride = 16;
        internal const int TextBoxTopFromBottom = 47;
        internal const int BottomBandTopFromBottom = 31;
        internal const int BottomTextTopFromBottom = 15;
        internal const int MinimumLineCount = 2;
        internal const int HeightPadding = 67;
        internal const int TitleCanvasWidth = 75;
        internal const int TitleCanvasHeight = 5;
        internal const int TitleCanvasOriginX = 37;
        internal const int TitleCanvasOriginY = 2;
        internal const int TitleCanvasCenteredAnchorX = 130;
        ...
        {
            _ringItemName = _runtimeCatalog != null
                && InventoryItemMetadataResolver.TryResolveItemName(_ringItemId, _runtimeCatalog, out string resolvedRingName)
                ? resolvedRingName
                : $"Item {_ringItemId}";
            _sealItemName = _runtimeCatalog != null
                && InventoryItemMetadataResolver.TryResolveItemName(_sealItemId, _runtimeCatalog, out string resolvedSealName)
                ? resolvedSealName
                : $"Item {_sealItemId}";
            _ringItemDescription = _runtimeCatalog != null
                && InventoryItemMetadataResolver.TryResolveItemDescription(_ringItemId, _runtimeCatalog, out string resolvedRingDescription)
                ? resolvedRingDescription.Trim()
                : string.Empty;
            _sealItemDescription = _runtimeCatalog != null
                && InventoryItemMetadataResolver.TryResolveItemDescription(_sealItemId, _runtimeCatalog, out string resolvedSealDescription)
