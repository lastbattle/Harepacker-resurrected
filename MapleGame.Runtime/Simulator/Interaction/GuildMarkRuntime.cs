...
namespace HaCreator.MapSimulator.Interaction
{
    internal sealed class GuildMarkRuntime
    {
        ...
        private readonly GuildMarkCatalogData _catalog;
        ...
        internal GuildMarkRuntime(IRuntimeAssetSource runtimeAssets)
        {
            _catalog = GuildMarkCatalog.LoadCatalog(runtimeAssets);
        }
