...
namespace HaCreator.MapSimulator
{
    public partial class MapSimulator
    {
        ...
        private bool TryGetAndroidCompanionRestrictionRejectReason(EquipmentChangeRequest request, out string rejectReason)
        {
            ...
            rejectReason = FieldInteractionRestrictionEvaluator.GetAndroidRestrictionMessage(fieldLimit, _mapInfo);
        ...
        private bool TryGetDragonCompanionRestrictionRejectReason(EquipmentChangeRequest request, out string rejectReason)
        {
            ...
            rejectReason = FieldInteractionRestrictionEvaluator.GetDragonCompanionRestrictionMessage(_mapInfo);
            return !string.IsNullOrWhiteSpace(rejectReason);
        }
