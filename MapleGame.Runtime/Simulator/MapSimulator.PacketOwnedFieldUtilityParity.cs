...
namespace HaCreator.MapSimulator
{
    public partial class MapSimulator
    {
        ...
        {
            return InventoryItemMetadataResolver.TryResolveItemInfoPath(itemId, runtimeServices.Assets, out string path)
                ? path
                : null;
        }
        ...
        private void PresentPacketOwnedAdminResult(PacketFieldUtilityAdminResult result)
        {
            ...
            {
                // The map snapshot is immutable; refresh presentation from its existing minimap.
        ...
        private bool TryResolvePacketOwnedQuizProblem(byte category, ushort problemId, out WzSubProperty problemProperty)
        {
            ...
            WzImage oxQuizImage = runtimeServices.Assets.FindImage("Etc", "OXQuiz.img");
            if (oxQuizImage == null)
            {
                return false;
            }
