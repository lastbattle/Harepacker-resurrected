...
namespace HaCreator.MapSimulator.Entities
{
    public class MobItem : BaseDXDrawableItem, ICombatEntity
    {
        ...
        private readonly RuntimeLife _runtimeLife;
        private readonly IRuntimeAssetSource _runtimeAssets;
        ...
        /// </summary>
        public bool IsProtectedFromPlayerDamage => _runtimeLife?.MobData?.DamagedByMob == true;

        /// <summary>
        /// Mirrors Mob.wz info/notAttack, which CMob::ProcessAttack checks before pending attack processing.
        /// </summary>
        public bool IsNotAttack => _runtimeLife?.MobData?.NotAttack == true;

        /// <summary>
        /// Mirrors CMob::IsNotEnemyMob for local-player delayed attack admission.
        /// </summary>
        public bool IsNotEnemyMob => ResolveClientNotEnemyMob(_runtimeLife?.MobData, AI?.IsDazzled == true);
        ...
        public bool UsesMobCombatLane
        {
            get
            {
                MobData mobData = _runtimeLife?.MobData;
        ...
        internal string DisplayName => _runtimeLife?.DisplayName;
        ...
        {
            if (!SpecialMobInteractionRules.ShouldUseDamagedByMobGreyBlink(_runtimeLife?.MobData) ||
        ...
        public Rectangle GetBodyHitbox(int tickCount)
        {
            ...
            {
                positionOffsetX = (int)(MovementInfo.X - _runtimeLife.X);
                positionOffsetY = (int)(MovementInfo.Y - _runtimeLife.Y);
            }
        ...
        /// </summary>
        /// <param name="_runtimeLife"></param>
        /// <param name="animationSet"></param>
        /// <param name="_nameTooltip"></param>
        public MobItem(RuntimeLife runtimeLife, MobAnimationSet animationSet, NameTooltipItem _nameTooltip, MobAnimationSet doomAnimationSet = null, IRuntimeAssetSource runtimeAssets = null)
            : base(animationSet.GetFrames(AnimationKeys.Stand) ?? animationSet.GetFrames(null), runtimeLife.Flip)
        {
            this._runtimeLife = runtimeLife;
        ...
        /// <param name="_nameTooltip"></param>
        public MobItem(RuntimeLife runtimeLife, List<IDXObject> frames, NameTooltipItem _nameTooltip, IRuntimeAssetSource runtimeAssets = null)
            : base(frames, runtimeLife.Flip)
        {
            this._runtimeLife = runtimeLife;
            _runtimeAssets = runtimeAssets;
            this._nameTooltip = _nameTooltip;
        ...
        /// <param name="_nameTooltip"></param>
        public MobItem(RuntimeLife runtimeLife, IDXObject frame0, NameTooltipItem _nameTooltip, IRuntimeAssetSource runtimeAssets = null)
            : base(frame0, runtimeLife.Flip)
        {
            this._runtimeLife = runtimeLife;
            _runtimeAssets = runtimeAssets;
            this._nameTooltip = _nameTooltip;
        ...
        private void InitializeMovement()
        {
            ...
            var mobData = _runtimeLife.MobData;
            ...
            MovementInfo.Initialize(
                _runtimeLife.X,
                _runtimeLife.Y,
                _runtimeLife.Rx0Shift,
                _runtimeLife.Rx1Shift,
                _runtimeLife.YShift,  // Pass yShift for correct foothold positioning
                isFlyingMob,
                isJumpingMob,
                noFlip
            );
            ...
            if (noFlip)
            {
                MovementInfo.FlipX = _runtimeLife.Flip;
            }
        ...
        private int DetermineSkillRange(MobSkillData skillData, bool isBoss)
        {
        ...
        private int ResolveAuthoredMobSkillRange(int skillId, int skillLevel)
        {
            if (skillId <= 0)
            {
                return 0;
            ...
            WzImage mobSkillImage = _runtimeAssets?.FindImage("Skill", "MobSkill");
        ...
        private int DetermineSkillCooldown(MobSkillData skillData, bool isBoss)
        {
        ...
        private int ResolveAuthoredMobSkillCooldown(int skillId, int skillLevel)
        {
            if (skillId <= 0)
            {
                return 0;
        ...
        private int ResolveAuthoredMobSkillMpCon(int skillId, int skillLevel)
        {
            if (skillId <= 0)
            {
                return 0;
        ...
        public RuntimeLife RuntimeLife => _runtimeLife;

        public int Width => LastFrameDrawn?.Width ?? 0;

        public int Height => LastFrameDrawn?.Height ?? 0;

        public int MobId => _runtimeLife?.Id != null? int.Parse(_runtimeLife.Id) : 0;

        public MobData MobData => _runtimeLife?.MobData;
        #endregion
        ...
        private bool RegisterAngerGaugeBurst(int tickCount)
        {
            ...
            string mobTemplateId = _runtimeLife?.Id;
