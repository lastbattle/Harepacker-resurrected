...
namespace HaCreator.MapSimulator.Entities
{
    ...
    {
        public RuntimeTooltipDefinition Tooltip { get; }

        public TooltipItem(RuntimeTooltipDefinition tooltip, List<IDXObject> frames)
            : base(frames, false)
        {
            Tooltip = tooltip;
        }
        ...
        public TooltipItem(RuntimeTooltipDefinition tooltip, IDXObject frame0)
            : base(frame0, false)
        {
            Tooltip = tooltip;
        }
