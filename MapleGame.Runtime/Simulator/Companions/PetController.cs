...
namespace HaCreator.MapSimulator.Companions
{
    ...
    public sealed class PetController : IDisposable
    {
        ...
        public PetController(GraphicsDevice device, IRuntimeDataServices runtimeServices = null)
        {
            _loader = new PetLoader(device, runtimeServices);
        }
        ...
        public void Dispose()
        {
            ...
            _disposed = true;
            Clear();
            _persistedStateByItemId.Clear();
            _currentMapIdProvider = null;
            _loader.Dispose();
        }
