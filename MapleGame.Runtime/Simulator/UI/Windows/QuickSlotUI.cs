...
namespace HaCreator.MapSimulator.UI
{
    ...
    public class QuickSlotUI : UIWindowBase
    {
        ...
        #region Constructor
        public QuickSlotUI(IDXObject frame, GraphicsDevice device, IRuntimeDataServices runtimeServices)
            : base(frame)
        {
        ...
        private void CreateSlotTextures(GraphicsDevice device)
        {
            ...
            _emptySlotTexture = GraphicsResourceCreationScope.Register(new Texture2D(device, SLOT_SIZE, SLOT_SIZE));
            ...
            _slotHighlightTexture = GraphicsResourceCreationScope.Register(new Texture2D(device, SLOT_SIZE, SLOT_SIZE));
            ...
            _cooldownOverlayTexture = GraphicsResourceCreationScope.Register(new Texture2D(device, SLOT_SIZE, SLOT_SIZE));
            ...
            _debugPlaceholder = GraphicsResourceCreationScope.Register(new Texture2D(device, 1, 1));
        ...
        private void DrawHoveredItemTooltip(SpriteBatch sprite, int renderWidth, int renderHeight, int absoluteSlotIndex)
        {
            ...
            InventoryItemTooltipMetadata metadata = InventoryItemMetadataResolver.ResolveTooltipMetadata(itemId, _runtimeServices.Catalog, inventoryType);
            ...
            int? maxStackSize = InventoryItemMetadataResolver.TryResolveMaxStackForItem(itemId, _runtimeServices.Assets, out int resolvedMaxStackSize)
        ...
        private void EnsurePrimaryQuickSlotSurface(int width, int height)
        {
            ...
            _primaryQuickSlotSurface = GraphicsResourceCreationScope.Register(new RenderTarget2D(
                _graphicsDevice,
                width,
                height,
                false,
