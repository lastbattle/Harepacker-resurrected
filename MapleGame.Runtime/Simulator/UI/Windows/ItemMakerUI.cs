...
namespace HaCreator.MapSimulator.UI
{
    public sealed class ItemMakerUI : UIWindowBase
    {
        ...
        public ItemMakerUI(IDXObject frame, Texture2D pixel, IRuntimeDataServices runtimeServices)
            : base(frame)
        {
            _pixel = pixel;
        ...
        {
            return itemId > 0
                   && _runtimeServices.Catalog.TryGetItemName(itemId, out RuntimeItemName itemInfo)
        ...
        private string CreateRecipeDescription(int itemId, bool usesRandomReward)
        {
        ...
        private string CreateDisassemblyDescription(int itemId)
        {
        ...
        private string FormatResultSummary(
        ...
        {
            WzImage itemMakeImage = _runtimeServices.Assets.FindImage("Etc", "ItemMake.img");
        ...
        private ItemMakerRecipe CreateRecipeFromWz(WzSubProperty recipeData, int outputItemId, int bucketKey)
        {
        ...
        private string ResolveCategoryLabel(int categoryKey, int sampleItemId)
        {
            ...
            if (_runtimeServices.Catalog.TryGetItemName(sampleItemId, out RuntimeItemName itemInfo) &&
                !string.IsNullOrWhiteSpace(itemInfo?.Category))
            {
                return itemInfo.Category.Trim();
            }
