...
namespace HaCreator.MapSimulator.UI
{
    internal sealed class RepairDurabilityWindow : UIWindowBase
    {
        ...
        public RepairDurabilityWindow(
            ...
            string feeLabelText,
            GraphicsDevice device, IRuntimeAssetCatalog catalog)
            : base(frame)
        {
        ...
        private void DrawHoveredItemTooltip(SpriteBatch sprite)
        {
            ...
            InventoryItemTooltipMetadata metadata = InventoryItemMetadataResolver.ResolveTooltipMetadata(itemId, _catalog, InventoryType.EQUIP);
