...
namespace HaCreator.MapSimulator.UI
{
    internal sealed class LogoutGiftWindow : UIWindowBase
    {
        ...
        {
            Texture2D texture = GraphicsResourceCreationScope.Register(new Texture2D(
        ...
        {
            Texture2D texture = GraphicsResourceCreationScope.Register(new Texture2D(device ?? throw new ArgumentNullException(nameof(device)), 1, 1));
