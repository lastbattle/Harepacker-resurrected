...
namespace HaCreator.MapSimulator.UI
{
    ...
    public class SkillMacroUI : UIWindowBase, ISoftKeyboardHost
    {
        ...
        private void CreateSlotTextures(GraphicsDevice device)
        {
            ...
            _emptySlotTexture = GraphicsResourceCreationScope.Register(new Texture2D(device, SKILL_ICON_SIZE, SKILL_ICON_SIZE));
            ...
            _slotHighlightTexture = GraphicsResourceCreationScope.Register(new Texture2D(device, SKILL_ICON_SIZE, SKILL_ICON_SIZE));
            ...
            _macroSlotTexture = GraphicsResourceCreationScope.Register(new Texture2D(device, MACRO_SLOT_WIDTH, MACRO_SLOT_HEIGHT));
            ...
            _selectedSlotTexture = GraphicsResourceCreationScope.Register(new Texture2D(device, MACRO_SLOT_WIDTH, MACRO_SLOT_HEIGHT));
            ...
            _textPixelTexture = GraphicsResourceCreationScope.Register(new Texture2D(device, 1, 1));
