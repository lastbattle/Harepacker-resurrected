...
namespace HaCreator.MapSimulator.UI
{
    internal sealed class GuildRankWindow : UIWindowBase
    {
        ...
        {
            Texture2D backgroundTexture = GuildMarkTextureCache.GetBackgroundTexture(_device, _runtimeAssets, _resourceCache, backgroundId, backgroundColorIndex);
            Texture2D markTexture = GuildMarkTextureCache.GetMarkTexture(_device, _runtimeAssets, _resourceCache, markId, markColorIndex);
