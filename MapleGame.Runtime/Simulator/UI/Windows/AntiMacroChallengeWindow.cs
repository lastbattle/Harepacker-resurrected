...
{
    internal sealed class AntiMacroChallengeWindow : UIWindowBase, ISoftKeyboardHost, IDisposable
    {
            ...
            : base(new DXObject(0, 0, CreateFallbackFrameTexture(graphicsDevice), 0))
        {
            ...
            Texture2D pixelTexture = HaSharedLibrary.Util.GraphicsResourceCreationScope.Register(new Texture2D(graphicsDevice, 1, 1));
        ...
        public void Dispose()
        {
            ...
            EditFocusGained = null;
            ClientForwardedFunctionKeyStateChanged = null;
            try { _nativeEditHost.Dispose(); }
            finally
            {
        ...
        {
            Texture2D texture = HaSharedLibrary.Util.GraphicsResourceCreationScope.Register(new Texture2D(graphicsDevice, FallbackWindowWidth, FallbackWindowHeight));
