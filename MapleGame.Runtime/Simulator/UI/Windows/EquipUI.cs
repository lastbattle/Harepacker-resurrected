...
namespace HaCreator.MapSimulator.UI
{
    public class EquipUI : UIWindowBase, IEquipmentPendingChangeWindow
    {
        ...
        public EquipUI(IDXObject frame, GraphicsDevice device, IRuntimeAssetSource runtimeAssets) : base(frame)
        {
            ...
            _overlayPixel = GraphicsResourceCreationScope.Register(new Texture2D(device, 1, 1));
        ...
        private bool TryRequestItemUpgrade(MouseState mouseState)
        {
            ...
            if (!characterSlot.HasValue || !ItemUpgradeUI.CanUpgrade(characterSlot.Value, part, _runtimeAssets))
            {
                return false;
            }
