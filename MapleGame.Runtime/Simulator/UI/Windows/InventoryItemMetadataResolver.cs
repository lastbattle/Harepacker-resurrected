...
namespace HaCreator.MapSimulator.UI
{
    ...
    public static class InventoryItemMetadataResolver
    {
        ...
        public static bool TryResolveItemName(int itemId, IRuntimeAssetCatalog runtimeCatalog, out string itemName)
        {
            ArgumentNullException.ThrowIfNull(runtimeCatalog);
            itemName = null;
            return runtimeCatalog.TryGetItemName(itemId, out RuntimeItemName itemInfo)
                   && !string.IsNullOrWhiteSpace(itemInfo?.Name)
                ? (itemName = itemInfo.Name) != null
                : false;
        }

        public static bool TryResolveItemDescription(int itemId, IRuntimeAssetCatalog runtimeCatalog, out string description)
        {
            ArgumentNullException.ThrowIfNull(runtimeCatalog);
            description = null;
            return runtimeCatalog.TryGetItemName(itemId, out RuntimeItemName itemInfo)
                   && !string.IsNullOrWhiteSpace(itemInfo?.Description)
                ? (description = itemInfo.Description) != null
                : false;
        }

        public static bool TryResolveItemTypeName(int itemId, IRuntimeAssetCatalog runtimeCatalog, out string typeName)
        {
            ArgumentNullException.ThrowIfNull(runtimeCatalog);
            typeName = null;
            return runtimeCatalog.TryGetItemName(itemId, out RuntimeItemName itemInfo)
                   && !string.IsNullOrWhiteSpace(itemInfo?.Category)
                ? (typeName = itemInfo.Category) != null
                : false;
        }

        public static bool IsPetPickupBlocked(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            if (itemId <= 0)
            {
                return false;
            ...
            WzSubProperty itemProperty = LoadItemProperty(itemId, runtimeAssets);
            return HasPetPickupRestriction(
                itemProperty?["spec"] as WzSubProperty,
                itemProperty?["specEx"] as WzSubProperty);
        }

        public static bool IsPickupBlocked(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            if (itemId <= 0)
            {
                return false;
        ...
        public static bool TryResolveSkillBookUseMetadata(int itemId, IRuntimeAssetCatalog runtimeCatalog, out SkillBookUseMetadata metadata)
        {
            ArgumentNullException.ThrowIfNull(runtimeCatalog);
            metadata = default;

            WzSubProperty itemProperty = LoadItemProperty(itemId, runtimeCatalog.Assets);
            if (itemProperty?["info"] is not WzSubProperty infoProperty)
            {
                return false;
            }

            return TryResolveSkillBookUseMetadata(infoProperty, TryResolveItemDescription(itemId, runtimeCatalog, out string description) ? description : null, out metadata);
        }
        ...
        public static bool TryResolveSpecScript(int itemId, IRuntimeAssetSource runtimeAssets, out string script)
        {
        ...
        public static bool TryResolveSpecScripts(int itemId, IRuntimeAssetSource runtimeAssets, out IReadOnlyList<string> scripts)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
        ...
        public static bool TryResolveSpecNpc(int itemId, IRuntimeAssetSource runtimeAssets, out int npcId)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            npcId = 0;
        ...
        public static bool TryResolveNpcReference(int itemId, IRuntimeAssetSource runtimeAssets, out int npcId)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            npcId = 0;
        ...
        public static bool HasAuthoredNpcInteraction(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            if (itemId <= 0)
            {
        ...
        public static bool IsWeddingInvitationItem(int itemId, IRuntimeAssetCatalog runtimeCatalog)
        {
            ArgumentNullException.ThrowIfNull(runtimeCatalog);
            if (itemId <= 0)
            {
        ...
        public static bool IsNotConsumedOnUse(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            WzSubProperty itemProperty = LoadItemProperty(itemId, runtimeAssets);
        ...
        public static bool IsConsumedOnPickup(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            WzSubProperty itemProperty = LoadItemProperty(itemId, runtimeAssets);
        ...
        public static bool IsRunOnPickup(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            WzSubProperty itemProperty = LoadItemProperty(itemId, runtimeAssets);
        ...
        public static bool IsOnlyPickup(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            WzSubProperty itemProperty = LoadItemProperty(itemId, runtimeAssets);
            return IsOnlyPickup(
        ...
        public static bool ShouldAutoRunOnPickupInteraction(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            if (itemId <= 0)
            {
        ...
        public static bool IsPetFoodItem(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            if (itemId <= 0)
            {
        ...
        public static bool IsRandomMorphItem(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            if (itemId <= 0)
            {
        ...
        public static bool TryResolveItemInfoPath(int itemId, IRuntimeAssetSource runtimeAssets, out string path)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            path = null;
            WzSubProperty itemProperty = LoadItemProperty(itemId, runtimeAssets);
        ...
        public static bool TryResolveTradeRestrictionFlags(int itemId, IRuntimeAssetSource runtimeAssets, out bool isCashItem, out bool isNotForSale, out bool isQuestItem)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            isCashItem = false;
            isNotForSale = false;
        ...
        public static bool TryResolveMaxStackForItem(int itemId, IRuntimeAssetSource runtimeAssets, out int maxStackSize)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            ...
            out QuestRewardRaiseItemMetadata metadata)
        {
            ...
            metadata = EnumerateRaiseItemMetadata(runtimeAssets)
        ...
        public static IReadOnlyList<ConsumeItemRequirementMetadata> ResolveConsumeItemRequirements(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            if (itemId <= 0)
            {
        ...
        public static int ResolveItemCooldownSeconds(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            if (itemId <= 0)
            {
        ...
        public static int ResolveSetupUseLevelRequirement(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            if (itemId <= 0)
            {
        ...
        public static bool TryResolveClientItemCrc(int itemId, IRuntimeAssetCatalog runtimeCatalog, out uint crc)
        {
            ArgumentNullException.ThrowIfNull(runtimeCatalog);
            crc = 0;
            if (itemId <= 0)
            ...
            WzSubProperty itemProperty = LoadItemProperty(itemId, runtimeCatalog.Assets);
            uint commonCrc = ComputeItemCommonCrc(itemId, itemProperty, runtimeCatalog);
        ...
        public static InventoryItemTooltipMetadata ResolveTooltipMetadata(
            int itemId,
            IRuntimeAssetCatalog runtimeCatalog,
            InventoryType fallbackType = InventoryType.NONE)
        {
            ArgumentNullException.ThrowIfNull(runtimeCatalog);
            InventoryType inventoryType = ResolveInventoryType(itemId);
            ...
            TryResolveItemName(itemId, runtimeCatalog, out string itemName);
            TryResolveItemDescription(itemId, runtimeCatalog, out string description);
            ...
            List<string> effectLines = BuildEffectLines(itemId, itemProperty, infoProperty, specProperty, specExProperty, runtimeCatalog);
            ...
            return new InventoryItemTooltipMetadata
            {
                ...
                TypeName = ResolveTypeName(itemId, inventoryType, runtimeCatalog),
        ...
        public static bool TryResolveInfoCanvas(int itemId, string canvasName, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            canvas = null;
        ...
        public static bool TryResolveTooltipIconCanvas(int itemId, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            canvas = ResolveTooltipIconCanvas(LoadItemProperty(itemId, runtimeAssets));
            return canvas != null;
        }

        public static bool TryResolveRewardPreviewIconCanvas(InventoryRewardPreviewItem rewardItem, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            canvas = null;
            if (rewardItem == null)
            ...
            if (TryResolveTooltipIconCanvas(rewardItem.ItemId, runtimeAssets, out canvas))
            {
                return true;
            }

            return TryResolveEffectFirstCanvas(rewardItem.EffectPath, runtimeAssets, out canvas);
        }

        public static IReadOnlyList<WzCanvasProperty> ResolveInfoCanvasSequence(int itemId, string groupName, IRuntimeAssetSource runtimeAssets, int limit = 8)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
        ...
        public static IReadOnlyList<InventoryRewardPreviewItem> ResolveRewardPreviewItems(int itemId, IRuntimeAssetSource runtimeAssets, int limit = 8)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            if (itemId <= 0)
            {
            ...
            return ResolveRewardPreviewItems(ResolveLinkedSubProperty(LoadItemProperty(itemId, runtimeAssets)?["reward"]), limit);
        }
        ...
        public static IReadOnlyList<InventoryMobPreviewItem> ResolveMobPreviewItems(int itemId, IRuntimeAssetSource runtimeAssets, int limit = 8)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            if (itemId <= 0)
            {
            ...
            return ResolveMobPreviewItemsFromItemProperty(LoadItemProperty(itemId, runtimeAssets), limit);
        }
        ...
        public static bool TryResolveRootCanvas(int itemId, string canvasPath, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            canvas = null;
            ...
            return TryResolveCanvasAtPath(LoadItemProperty(itemId, runtimeAssets), canvasPath, out canvas);
        }

        public static bool TryResolveEffectFirstCanvas(string effectPath, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            return TryResolveEffectFirstCanvas(effectPath, runtimeAssets, 0, out canvas);
        }

        private static bool TryResolveEffectFirstCanvas(string effectPath, IRuntimeAssetSource runtimeAssets, int depth, out WzCanvasProperty canvas)
        {
            canvas = null;
            if (depth > 4)
            {
            ...
            WzImage effectImage = runtimeAssets.FindImage("Effect", imagePath);
            if (effectImage == null)
            {
                return false;
            }
            ...
            return TryResolveFirstCanvasFromAnimationProperty(effectProperty, out canvas)
                   || TryResolveEffectVisualFirstCanvas(effectProperty, runtimeAssets, depth + 1, out canvas);
        }

        public static bool TryResolveInfoEffectFirstCanvas(int itemId, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            canvas = null;
            if (itemId <= 0)
            ...
            return TryResolveEffectFirstCanvas(effectPath, runtimeAssets, out canvas);
        }

        public static bool TryResolveInfoPathFirstCanvas(int itemId, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            canvas = null;
            if (itemId <= 0)
            ...
            return TryResolveWzDataPathFirstCanvas(path, runtimeAssets, out canvas);
        }

        public static bool TryResolveRootEffectFirstCanvas(int itemId, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            if (itemId <= 0)
            {
            ...
            return TryResolveRootEffectFirstCanvas(LoadItemProperty(itemId, runtimeAssets), out canvas);
        }

        public static bool TryResolveMobPreviewCanvas(InventoryMobPreviewItem mobItem, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            canvas = null;
            ...
            WzImage mobImage = runtimeAssets.FindImage(
                "Mob",
            ...
            WzImage linkedMobImage = runtimeAssets.FindImage("Mob", linkedMobId + ".img");
        ...
        public static bool TryResolveNpcPreviewCanvas(int itemId, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            canvas = null;
            if (itemId <= 0)
            ...
            WzSubProperty itemProperty = LoadItemProperty(itemId, runtimeAssets);
            return TryResolveNpcPreviewCanvas(itemProperty, runtimeAssets, out canvas);
        }

        private static bool TryResolveNpcPreviewCanvas(WzSubProperty itemProperty, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            canvas = null;
            ...
            return TryResolveNpcFirstCanvas(npcId, runtimeAssets, out canvas);
        }

        private static bool TryResolveNpcFirstCanvas(int npcId, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            canvas = null;
            if (npcId <= 0)
            {
            ...
            WzImage npcImage = runtimeAssets.FindImage(
                "Npc",
            ...
            WzImage linkedNpcImage = runtimeAssets.FindImage("Npc", linkedNpcId + ".img");
        ...
        private static bool TryResolveWzDataPathFirstCanvas(string dataPath, IRuntimeAssetSource runtimeAssets, out WzCanvasProperty canvas)
        {
            canvas = null;
            ...
            WzImage image = runtimeAssets.FindImage(category, imagePath);
            if (image == null)
            {
                return false;
            }
        ...
        private static bool TryResolveEffectVisualFirstCanvas(WzSubProperty effectProperty, IRuntimeAssetSource runtimeAssets, int depth, out WzCanvasProperty canvas)
        {
            canvas = null;
            if (effectProperty?.WzProperties == null)
            {
            ...
            if (!string.IsNullOrWhiteSpace(directVisual)
                && TryResolveEffectFirstCanvas(directVisual, runtimeAssets, depth, out canvas))
            {
                return true;
            }
            ...
            {
                if (TryResolveEffectFirstCanvas(visualRows[i].VisualPath, runtimeAssets, depth, out canvas))
                {
                    return true;
                }
            }
            ...
            out WzCanvasProperty bottomCanvas)
        {
            return TryResolveSampleUiFrame(
                LoadItemProperty(itemId, runtimeAssets),
                out topCanvas,
                out centerCanvas,
                out bottomCanvas);
        }
        ...
        private static WzSubProperty LoadItemProperty(int itemId, IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);
            ...
            WzImage itemImage = runtimeAssets.FindImage(category, imagePath);
            if (itemImage == null)
            {
                return null;
            }
        ...
        private static IReadOnlyList<QuestRewardRaiseItemMetadata> EnumerateRaiseItemMetadata(IRuntimeAssetSource runtimeAssets)
        {
            ArgumentNullException.ThrowIfNull(runtimeAssets);

            var metadata = new List<QuestRewardRaiseItemMetadata>();
            WzImage itemImage = runtimeAssets.FindImage("Item", "Etc/0422.img");
            if (itemImage == null)
            {
                return Array.Empty<QuestRewardRaiseItemMetadata>();
            }
        ...
        {
            return IsWeddingInvitationItem(itemId, inventoryType, itemName, itemDescription, runtimeCatalog);
        }
        ...
        internal static bool IsWeddingInvitationItem(
            ...
            string itemName,
            string itemDescription,
            IRuntimeAssetCatalog runtimeCatalog = null)
        {
            ...
            string resolvedItemName = !string.IsNullOrWhiteSpace(itemName)
                ? itemName
                : (runtimeCatalog != null && TryResolveItemName(itemId, runtimeCatalog, out string metadataName) ? metadataName : null);
            string resolvedItemDescription = !string.IsNullOrWhiteSpace(itemDescription)
                ? itemDescription
                : (runtimeCatalog != null && TryResolveItemDescription(itemId, runtimeCatalog, out string metadataDescription) ? metadataDescription : null);
        ...
        private static uint ComputeItemCommonCrc(int itemId, WzSubProperty itemProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            string description = runtimeCatalog != null && TryResolveItemDescription(itemId, runtimeCatalog, out string resolvedDescription)
                ? resolvedDescription ?? string.Empty
                : string.Empty;
            string name = TryResolveItemName(itemId, runtimeCatalog, out string resolvedName)
            ...
            IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            AppendBuffItemEffectLines(effectLines, itemProperty?["buff"] as WzSubProperty, runtimeCatalog);
            AppendScriptedUseEffectLines(effectLines, specProperty, specExProperty, runtimeCatalog);
            AppendPickupModifierEffectLines(effectLines, effectSpecProperty, runtimeCatalog);
            AppendMobEffectLines(effectLines, itemProperty?["mob"] as WzSubProperty, runtimeCatalog);
            AppendRewardEffectLines(effectLines, itemProperty?["reward"] as WzSubProperty, runtimeCatalog);
            ...
            AppendMoveToEffectLine(effectLines, TryGetPositiveInt(effectSpecProperty["moveTo"]), runtimeCatalog);
            ...
            AppendReturnMapRecordEffectLine(effectLines, effectSpecProperty["returnMapQR"], runtimeCatalog);
            ...
            AppendDeathmarkEffectLine(effectLines, itemId, effectSpecProperty, runtimeCatalog);
            AppendMobEffectLines(effectLines, effectSpecProperty["mob"] as WzSubProperty, runtimeCatalog);
            ...
            AppendRandomPickupEffectLines(effectLines, specProperty, specExProperty, runtimeCatalog);
            ...
            IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            AppendInfoMetadataLines(metadataLines, itemId, infoProperty, specProperty, specExProperty, runtimeCatalog);
            AppendMonsterBookMetadataLines(metadataLines, infoProperty, runtimeCatalog);
            AppendQuestRequirementMetadataLines(metadataLines, infoProperty, runtimeCatalog);
            AppendConsumeItemMetadataLines(metadataLines, infoProperty, runtimeCatalog);
            AppendSpecSkillMetadataLines(metadataLines, specProperty, specExProperty, runtimeCatalog);
        ...
        private static string ResolveTypeName(int itemId, InventoryType inventoryType, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (runtimeCatalog != null && runtimeCatalog.TryGetItemName(itemId, out RuntimeItemName itemInfo)
                && !string.IsNullOrWhiteSpace(itemInfo?.Category))
            {
        ...
        private static void AppendMoveToEffectLine(List<string> effectLines, int? moveToMapId, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            string destinationName = ResolveMapName(moveToMapId.Value, runtimeCatalog);
            ...
            IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            {
                string npcName = ResolveNpcName(npcId, runtimeCatalog);
            ...
            IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            {
                string label = ResolveTooltipItemLabel(randomPickupItemIds[i], runtimeCatalog);
        ...
        private static void AppendBuffItemEffectLines(List<string> effectLines, WzSubProperty buffProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            foreach (WzImageProperty child in buffProperty.WzProperties)
            {
                ...
                string label = ResolveTooltipItemLabel(buffItemId, runtimeCatalog);
        ...
        private static void AppendPickupModifierEffectLines(List<string> effectLines, WzSubProperty specProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            string targetItemLabel = itemCode > 0
                ? ResolveTooltipItemLabel(itemCode, runtimeCatalog)
                : string.Empty;
        ...
        private static void AppendRewardEffectLines(List<string> effectLines, WzSubProperty rewardProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (rewardProperty?.WzProperties == null)
            {
                return;
            ...
            IReadOnlyList<string> previewLines = BuildRewardPreviewLines(rewardProperty, RewardPreviewLineLimit, runtimeCatalog);
        ...
        private static void AppendMobEffectLines(List<string> effectLines, WzSubProperty mobProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (mobProperty?.WzProperties == null)
            {
                return;
            ...
            foreach (WzImageProperty child in mobProperty.WzProperties)
            {
                ...
                string mobLabel = ResolveMobTooltipLabel(mobId, runtimeCatalog);
        ...
        private static void AppendReturnMapRecordEffectLine(List<string> effectLines, WzImageProperty property, IRuntimeAssetCatalog runtimeCatalog)
        {
            int returnMapRecordId = GetIntValue(property);
            if (returnMapRecordId > 0)
            {
                string questLabel = ResolveQuestTooltipLabel(returnMapRecordId, runtimeCatalog);
        ...
        private static void AppendDeathmarkEffectLine(List<string> effectLines, int itemId, WzSubProperty specProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            string description = TryResolveItemDescription(itemId, runtimeCatalog, out string resolvedDescription)
            ...
            IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            AppendSkillBookMetadataLines(metadataLines, infoProperty, runtimeCatalog);
            AppendRequiredMapMetadataLines(metadataLines, infoProperty, runtimeCatalog);
            AppendTargetMobMetadataLines(metadataLines, infoProperty, specProperty, runtimeCatalog);
            AppendInfoNpcMetadataLines(metadataLines, infoProperty, specProperty, runtimeCatalog);
            AppendStateChangeItemMetadataLines(metadataLines, infoProperty, runtimeCatalog);
            AppendItemPeriodMetadataLines(metadataLines, infoProperty);
            AppendCashItemExtensionMetadataLines(metadataLines, infoProperty);
            AppendCreateMetadataLines(metadataLines, infoProperty, runtimeCatalog);
            AppendReplaceMetadataLines(metadataLines, infoProperty, runtimeCatalog);
            ...
            AppendGrowthItemMetadataLines(metadataLines, infoProperty, runtimeCatalog);
            ...
            AppendRecipeMetadataLines(metadataLines, specProperty, specExProperty, runtimeCatalog);
            AppendConditionalMapMetadataLines(metadataLines, specProperty, runtimeCatalog);
            ...
            AppendAdditionalInfoFlagsMetadataLines(metadataLines, infoProperty, specProperty, runtimeCatalog);
        }
        ...
        private static void AppendStateChangeItemMetadataLines(List<string> metadataLines, WzSubProperty infoProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            int stateChangeItemId = GetIntOrStringValue(infoProperty?["stateChangeItem"]);
            if (stateChangeItemId > 0)
            {
                string stateChangeItemLabel = ResolveTooltipItemLabel(stateChangeItemId, runtimeCatalog);
        ...
        private static void AppendSkillBookMetadataLines(List<string> metadataLines, WzSubProperty infoProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (infoProperty == null)
            {
                return;
            ...
            foreach (WzImageProperty child in skillProperty.WzProperties)
            {
                ...
                string skillLine = ResolveSkillTooltipLine(skillId, runtimeCatalog);
        ...
        private static void AppendRequiredMapMetadataLines(List<string> metadataLines, WzSubProperty infoProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            foreach (WzImageProperty child in reqMapProperty.WzProperties)
            {
                ...
                string mapName = ResolveMapName(mapId, runtimeCatalog);
        ...
        private static void AppendMonsterBookMetadataLines(List<string> metadataLines, WzSubProperty infoProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (infoProperty == null)
            {
                return;
            ...
            IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            {
                metadataLines.Add($"Target Mob: {ResolveMobTooltipLabel(targetMobId, runtimeCatalog)}");
            }
        ...
        private static void AppendQuestRequirementMetadataLines(List<string> metadataLines, WzSubProperty infoProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (infoProperty == null)
            {
                return;
            ...
            {
                metadataLines.Add($"Requires Quest In Progress: {ResolveQuestTooltipLabel(requiredQuestId, runtimeCatalog)}");
            }
        ...
        private static void AppendConsumeItemMetadataLines(List<string> metadataLines, WzSubProperty infoProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            WzSubProperty consumeItemProperty = infoProperty?["consumeitem"] as WzSubProperty
                                               ?? infoProperty?["consumeItem"] as WzSubProperty;
            ...
            IReadOnlyList<string> requirementLines = BuildConsumeItemRequirementLines(consumeItemProperty, ConsumeItemRequirementLineLimit, runtimeCatalog);
        ...
        private static void AppendCreateMetadataLines(List<string> metadataLines, WzSubProperty infoProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            metadataLines.Add($"Creates: {ResolveTooltipItemLabel(createdItemId, runtimeCatalog)}");
        ...
        private static void AppendReplaceMetadataLines(List<string> metadataLines, WzSubProperty infoProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            {
                metadataLines.Add($"Replaces with: {ResolveTooltipItemLabel(replacementItemId, runtimeCatalog)}");
            }
        ...
        private static void AppendGrowthItemMetadataLines(List<string> metadataLines, WzSubProperty infoProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (infoProperty == null)
            {
                return;
            ...
            if (questId > 0)
            {
                metadataLines.Add($"Related Quest: {ResolveQuestTooltipLabel(questId, runtimeCatalog)}");
            }
        ...
        private static void AppendRecipeMetadataLines(List<string> metadataLines, WzSubProperty specProperty, WzSubProperty specExProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (specProperty == null && specExProperty == null)
            {
                return;
            ...
            {
                metadataLines.Add($"Required Skill: {ResolveSkillTooltipLabel(requiredSkillId, runtimeCatalog)}");
            }
        ...
        private static void AppendConditionalMapMetadataLines(List<string> metadataLines, WzSubProperty specProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            foreach (WzImageProperty child in conditionProperty.WzProperties)
            {
                ...
                string line = $"Usable In: {FormatMapRangeLabel(startMapId, endMapId, runtimeCatalog)}";
                if (seenLines.Add(line))
                {
                    metadataLines.Add(line);
                }
        ...
        private static void AppendAdditionalInfoFlagsMetadataLines(
            List<string> metadataLines,
            WzSubProperty infoProperty,
            WzSubProperty specProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (infoProperty == null)
            {
                return;
            ...
            AppendPetUtilityMetadataLines(metadataLines, infoProperty, runtimeCatalog);
            ...
            if (nickSkillId > 0)
            {
                metadataLines.Add($"Nickname Effect: {ResolveSkillTooltipLabel(nickSkillId, runtimeCatalog)}");
            }
        ...
        private static void AppendPetUtilityMetadataLines(List<string> metadataLines, WzSubProperty infoProperty, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (infoProperty == null)
            {
                return;
        ...
        internal static IReadOnlyList<string> BuildPetUtilityMetadataLinesForTesting(IRuntimeAssetCatalog runtimeCatalog, WzSubProperty infoProperty)
        {
            List<string> metadataLines = new();
            AppendCashAvailabilityMetadataLines(metadataLines, infoProperty);
            AppendPetUtilityMetadataLines(metadataLines, infoProperty, runtimeCatalog);
        ...
        private static string ResolveMapName(int mapId, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            {
                if (!runtimeCatalog.TryGetMapName(candidateKeys[i], out RuntimeMapName mapInfo)
                    || mapInfo == null)
                {
                    continue;
                }

                string streetName = mapInfo.StreetName?.Trim();
                string mapName = mapInfo.MapName?.Trim();
        ...
        private static string ResolveNpcName(int npcId, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (runtimeCatalog == null)
            {
                return string.Empty;
            ...
            return runtimeCatalog.TryGetNpcName(key, out RuntimeNpcName npcInfo)
                   && npcInfo != null
                ? npcInfo.Name?.Trim() ?? string.Empty
                : string.Empty;
        }

        private static string ResolveMobName(int mobId, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (runtimeCatalog == null)
            {
                return string.Empty;
            ...
            return runtimeCatalog.TryGetMobName(key, out RuntimeMobName mobInfo)
                   && !string.IsNullOrWhiteSpace(mobInfo?.Name)
                ? mobInfo.Name.Trim()
                : string.Empty;
        }

        private static string ResolveMobTooltipLabel(int mobId, IRuntimeAssetCatalog runtimeCatalog)
        {
            string mobName = ResolveMobName(mobId, runtimeCatalog);
        ...
        private static string ResolveTooltipItemLabel(int itemId, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (runtimeCatalog != null && TryResolveItemName(itemId, runtimeCatalog, out string itemName) && !string.IsNullOrWhiteSpace(itemName))
            {
        ...
        private static string ResolveSkillTooltipLine(int skillId, IRuntimeAssetCatalog runtimeCatalog)
        {
            string skillName = runtimeCatalog == null ? string.Empty : ResolveSkillName(skillId, runtimeCatalog);
            return string.IsNullOrWhiteSpace(skillName)
                ? $"Skill: #{skillId.ToString(CultureInfo.InvariantCulture)}"
                : $"Skill: {skillName}";
        }

        private static string FormatMapRangeLabel(int startMapId, int endMapId, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (startMapId == endMapId)
            {
                string mapName = ResolveMapName(startMapId, runtimeCatalog);
                return string.IsNullOrWhiteSpace(mapName)
                    ? startMapId.ToString(CultureInfo.InvariantCulture)
                    : mapName;
            }

            string startLabel = ResolveMapName(startMapId, runtimeCatalog);
            if (string.IsNullOrWhiteSpace(startLabel))
            {
                startLabel = startMapId.ToString(CultureInfo.InvariantCulture);
            }

            string endLabel = ResolveMapName(endMapId, runtimeCatalog);
        ...
        private static string ResolveSkillTooltipLabel(int skillId, IRuntimeAssetCatalog runtimeCatalog)
        {
            string skillName = runtimeCatalog == null ? string.Empty : ResolveSkillName(skillId, runtimeCatalog);
            return string.IsNullOrWhiteSpace(skillName)
                ? $"Skill #{skillId.ToString(CultureInfo.InvariantCulture)}"
        ...
        private static string ResolveQuestTooltipLabel(int questId, IRuntimeAssetCatalog runtimeCatalog)
        {
            if (runtimeCatalog == null)
            {
                return $"Quest #{questId.ToString(CultureInfo.InvariantCulture)}";
            }
            WzImage questImage = runtimeCatalog.Assets.FindImage("Quest", "QuestInfo.img");
            if (questImage != null
                && questImage[questId.ToString(CultureInfo.InvariantCulture)] is WzSubProperty questProperty)
            {
        ...
        private static IReadOnlyList<string> BuildRewardPreviewLines(WzSubProperty rewardProperty, int previewLineLimit, IRuntimeAssetCatalog runtimeCatalog)
        {
            ...
            for (int i = 0; i < visibleCount; i++)
            {
                ...
                if (entry.ItemId > 0)
                {
                    string itemLabel = ResolveTooltipItemLabel(entry.ItemId, runtimeCatalog);
        ...
        private static IReadOnlyList<string> BuildConsumeItemRequirementLines(WzSubProperty consumeItemProperty, int previewLineLimit, IRuntimeAssetCatalog runtimeCatalog)
        {
            List<string> lines = new();
            ...
            for (int i = 0; i < visibleCount; i++)
            {
                ...
                string itemLabel = ResolveTooltipItemLabel(itemId, runtimeCatalog);
        ...
        public static IReadOnlyList<string> BuildRewardPreviewLinesForTests(IRuntimeAssetCatalog runtimeCatalog, WzSubProperty rewardProperty, int previewLineLimit = RewardPreviewLineLimit)
        {
            return BuildRewardPreviewLines(rewardProperty, previewLineLimit, runtimeCatalog);
        }

        public static IReadOnlyList<string> BuildConsumeItemRequirementLinesForTests(IRuntimeAssetCatalog runtimeCatalog, WzSubProperty consumeItemProperty, int previewLineLimit = ConsumeItemRequirementLineLimit)
        {
            return BuildConsumeItemRequirementLines(consumeItemProperty, previewLineLimit, runtimeCatalog);
        }
        ...
        public static IReadOnlyList<string> BuildEffectLinesForTests(IRuntimeAssetCatalog runtimeCatalog, WzSubProperty specProperty)
        {
            return BuildEffectLines(0, null, null, specProperty, null, runtimeCatalog);
        }

        public static IReadOnlyList<string> BuildEffectLinesForTests(IRuntimeAssetCatalog runtimeCatalog, int itemId, WzSubProperty specProperty)
        {
            return BuildEffectLines(itemId, null, null, specProperty, null, runtimeCatalog);
        }

        public static IReadOnlyList<string> BuildEffectLinesForTests(IRuntimeAssetCatalog runtimeCatalog, WzSubProperty infoProperty, WzSubProperty specProperty)
        {
            return BuildEffectLines(0, null, infoProperty, specProperty, null, runtimeCatalog);
        }

        public static IReadOnlyList<string> BuildEffectLinesWithSpecExForTests(IRuntimeAssetCatalog runtimeCatalog, WzSubProperty infoProperty, WzSubProperty specProperty, WzSubProperty specExProperty)
        {
            return BuildEffectLines(0, null, infoProperty, specProperty, specExProperty, runtimeCatalog);
        }

        public static IReadOnlyList<string> BuildEffectLinesWithItemPropertyForTests(IRuntimeAssetCatalog runtimeCatalog, WzSubProperty itemProperty, WzSubProperty infoProperty, WzSubProperty specProperty)
        {
            return BuildEffectLines(0, itemProperty, infoProperty, specProperty, null, runtimeCatalog);
        }

        public static IReadOnlyList<string> BuildQuestRequirementMetadataLinesForTests(IRuntimeAssetCatalog runtimeCatalog, WzSubProperty infoProperty)
        {
            List<string> lines = new();
            AppendQuestRequirementMetadataLines(lines, infoProperty, runtimeCatalog);
            return lines;
        }

        public static IReadOnlyList<string> BuildInfoMetadataLinesForTests(IRuntimeAssetCatalog runtimeCatalog, int itemId, WzSubProperty infoProperty)
        {
            List<string> lines = new();
            AppendInfoMetadataLines(lines, itemId, infoProperty, null, null, runtimeCatalog);
            return lines;
        }

        public static IReadOnlyList<string> BuildMetadataLinesForTests(IRuntimeAssetCatalog runtimeCatalog, WzSubProperty infoProperty, WzSubProperty specProperty)
        {
        ...
        public static IReadOnlyList<string> BuildMetadataLinesWithSpecExForTests(IRuntimeAssetCatalog runtimeCatalog, WzSubProperty infoProperty, WzSubProperty specProperty, WzSubProperty specExProperty)
        {
            return BuildMetadataLines(
                0,
                infoProperty,
        ...
        public static IReadOnlyList<string> BuildReturnMapRecordEffectLinesForTests(IRuntimeAssetCatalog runtimeCatalog, WzImageProperty property)
        {
            List<string> lines = new();
            AppendReturnMapRecordEffectLine(lines, property, runtimeCatalog);
            return lines;
        }

        private static string ResolveSkillName(int skillId, IRuntimeAssetCatalog runtimeCatalog)
        {
            ArgumentNullException.ThrowIfNull(runtimeCatalog);

            string key = skillId.ToString(CultureInfo.InvariantCulture);
            return runtimeCatalog.TryGetSkillName(key, out RuntimeSkillName skillInfo)
                   && skillInfo != null
                ? skillInfo.Name?.Trim() ?? string.Empty
                : string.Empty;
        }
