...
namespace HaCreator.MapSimulator
{
    public partial class MapSimulator
    {
        ...
        private readonly PacketOwnedFuncKeyConfigStore _packetOwnedFuncKeyConfigStore;
        ...
        {
            string title = InventoryItemMetadataResolver.TryResolveItemName(itemId, runtimeServices.Catalog, out string itemName)
        ...
        private string ResolvePacketOwnedPetConsumeItemLabel(int itemId)
        {
            if (itemId <= 0)
            {
                return "none";
