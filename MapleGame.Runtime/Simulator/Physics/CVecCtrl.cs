...
namespace HaCreator.MapSimulator.Physics
{
    ...
    public class CVecCtrl
    {
        ...
        /// </summary>
        public RuntimeFoothold FallStartFoothold { get; set; }
        ...
        private Func<float, float, float, RuntimeLadderOrRope?> _ladderOrRopeLookup;
        #endregion
        ...
        /// </summary>
        public RuntimeFoothold GetFoothold()
        {
            return CurrentFoothold;
        }

        public void SetLadderOrRopeLookup(Func<float, float, float, RuntimeLadderOrRope?> ladderOrRopeLookup)
        {
        ...
        {
            if (TryGetLadderOrRope(x, y, 0f, out RuntimeLadderOrRope ladderOrRope))
            {
        ...
        public bool TryGetLadderOrRope(double x, double y, double searchRange, out RuntimeLadderOrRope ladderOrRope)
        {
        ...
        public void LandOnFoothold(RuntimeFoothold fh)
        {
            if (NoLandingMap)
            {
                DetachFromFoothold();
