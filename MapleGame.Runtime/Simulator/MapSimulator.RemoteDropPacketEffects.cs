...
namespace HaCreator.MapSimulator
{
    ...
    public partial class MapSimulator
    {
        ...
        private WzImageProperty ResolvePacketOwnedDropExplodeHitRoot()
        {
            WzImage skillImage = runtimeServices.Assets.FindImage("Skill", PacketOwnedDropExplosionPresentation.SkillImageName);
