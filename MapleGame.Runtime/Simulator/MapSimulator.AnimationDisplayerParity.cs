...
namespace HaCreator.MapSimulator
{
    ...
    public partial class MapSimulator
    {
        ...
        private sealed class AnimationDisplayerPacketOwnedAreaOneTimeOwnerState
        {
            public string EffectUol { get; init; }
        ...
        private void ClearAnimationDisplayerState()
        {
            ...
            _animationDisplayerPacketOwnedAreaOneTimeOwnerStates.Clear();
        ...
        private bool TryRegisterAnimationDisplayerExplosionAnimation(string effectUol, Rectangle area, out string message)
        {
            ...
            int initialElapsedMs = ResolveAnimationDisplayerPacketOwnedAreaOneTimeInitialElapsed(
                BuildAnimationDisplayerPacketOwnedExplosionOwnerSlotKey(effectUol),
                effectUol,
            ...
            Func<string, WzImageProperty> propertyResolver)
        {
            ...
            Func<string, WzImageProperty> resolver = propertyResolver ?? throw new ArgumentNullException(nameof(propertyResolver));
        ...
        private int ResolveAnimationDisplayerPacketOwnedAreaOneTimeInitialElapsed(
            string ownerSlotKey,
            string effectUol,
            Rectangle area,
            int updateIntervalMs,
            ...
            int currentTime)
        {
            ...
            int initialElapsedMs = 0;
            if (_animationDisplayerPacketOwnedAreaOneTimeOwnerStates.TryGetValue(
                    ownerSlotKey,
                    out AnimationDisplayerPacketOwnedAreaOneTimeOwnerState existingState)
                && existingState != null)
            {
                initialElapsedMs = ResolveAnimationDisplayerPacketOwnedAreaOneTimeRestoreElapsedCore(
                    existingState.EffectUol,
                    existingState.Area,
            ...
            _animationDisplayerPacketOwnedAreaOneTimeOwnerStates[ownerSlotKey] =
                new AnimationDisplayerPacketOwnedAreaOneTimeOwnerState
                {
                    EffectUol = effectUol,
                    Area = area,
        ...
        private static int ResolveAnimationDisplayerPacketOwnedAreaOneTimeRestoreElapsedCore(
            string previousEffectUol,
        ...
        internal static int ResolveAnimationDisplayerPacketOwnedAreaOneTimeRestoreElapsedForTesting(
            string previousEffectUol,
            Rectangle previousArea,
            int previousUpdateIntervalMs,
            int previousUpdateCount,
            ...
            int currentTime)
        {
            return ResolveAnimationDisplayerPacketOwnedAreaOneTimeRestoreElapsedCore(
                previousEffectUol,
                previousArea,
        ...
        private IEnumerable<string> EnumerateAnimationDisplayerSkillUseBranchNames(SkillCastInfo castInfo)
        {
            ...
            WzImage skillImage = runtimeServices.Assets.FindImage("Skill", $"{skillId / 10000}.img");
        ...
        private WzImageProperty ResolveAnimationDisplayerPropertyStatic(string effectUol)
        {
            if (string.IsNullOrWhiteSpace(effectUol))
            {
                return null;
            ...
            WzImage image = runtimeServices.Assets.FindImage(category, imageName);
        ...
        private WzSubProperty ResolveAnimationDisplayerFollowEquipmentProperty(int itemId)
        {
            if (itemId <= 0)
            {
                return null;
            ...
            WzImage itemImage = runtimeServices.Assets.FindImage("Character", equipDataPath);
        ...
        private string BuildAnimationDisplayerFollowEquipmentEffectUol(string effectPath)
        {
