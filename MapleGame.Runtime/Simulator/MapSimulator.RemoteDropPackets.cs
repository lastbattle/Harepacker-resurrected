...
namespace HaCreator.MapSimulator
{
    public partial class MapSimulator
    {
        ...
        {
            if (_runtimePhysicsSnapshot?.Footholds == null)
            {
                return null;
            }

            return TryResolvePacketDropFootholdLayerMetadataForParity(
                _runtimePhysicsSnapshot?.Footholds
                    .OfType<RuntimeFoothold>()
        ...
        {
            position = default;
            if (!TryResolveRemotePetPickupPositionByOwnerForPacketParity(
                    ownerCharacterId,
                    slotIndex,
                    actorId,
                    _remoteUserPool,
        ...
        internal static bool TryResolveRemotePetPickupPositionByOwnerForPacketParity(
            int ownerCharacterId,
            int slotIndex,
            int actorId,
