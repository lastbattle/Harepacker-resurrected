...
namespace HaCreator.MapSimulator.Loaders
{
    public static partial class UIWindowLoader
    {
        ...
        {
            using System.IDisposable resourceCreationScope = manager?.BeginResourceCreationScope();
            ...
            IRuntimeAssetSource runtimeAssets)
        {
            ...
            UIWindowBase window = CreatePacketOwnedStoreBankWindow(uiWindow2Image, basicImage, soundUIImage, device, position, runtimeAssets);
            if (window != null)
            {
                manager.RegisterCustomWindow(window);
            }
            ...
            IRuntimeDataServices runtimeServices)
        {
            ...
            ShopScannerWindow window = CreateShopScannerWindow(uiWindowImage, uiWindow2Image, basicImage, soundUIImage, device, position, runtimeServices);
            if (window != null)
            {
                manager.RegisterCustomWindow(window);
            }
