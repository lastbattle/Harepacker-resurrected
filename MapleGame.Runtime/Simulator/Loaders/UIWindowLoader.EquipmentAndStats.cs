...
namespace HaCreator.MapSimulator.Loaders
{
    public static partial class UIWindowLoader
    {
        ...
        public static EquipUI CreateEquipWindow(
            ...
            GraphicsDevice device, int screenWidth, int screenHeight, IRuntimeAssetSource runtimeAssets)
        {
            return CreateEquipWindow(uiWindowImage, null, soundUIImage, device, screenWidth, screenHeight, runtimeAssets);
        }
            ...
            IRuntimeDataServices runtimeServices)
        {
            ...
            {
                return CreateEquipWindowBigBang(uiWindow2Image, uiWindow1Image, basicImage, soundUIImage, device, screenWidth, screenHeight, runtimeServices);
            }
            return CreateEquipWindow(uiWindow1Image, basicImage, soundUIImage, device, screenWidth, screenHeight, runtimeServices.Assets);
        }
            ...
            GraphicsDevice device, int screenWidth, int screenHeight, IRuntimeAssetSource runtimeAssets)
        {
            ...
            {
                return CreatePlaceholderEquip(device, screenWidth, screenHeight, runtimeAssets);
            }
            ...
            EquipUI equip = new EquipUI(frame, device, runtimeAssets);
            ...
            IRuntimeDataServices runtimeServices)
        {
            ...
            {
                return CreatePlaceholderEquipBigBang(device, screenWidth, screenHeight, runtimeServices);
            }
            ...
            EquipUIBigBang equip = new EquipUIBigBang(frame, device, runtimeServices);
        ...
        private static EquipUI CreatePlaceholderEquip(GraphicsDevice device, int screenWidth, int screenHeight, IRuntimeAssetSource runtimeAssets)
        {
            int width = 210;
            int height = 290;
        ...
        private static EquipUIBigBang CreatePlaceholderEquipBigBang(
            GraphicsDevice device,
            int screenWidth,
            int screenHeight,
            IRuntimeDataServices runtimeServices)
