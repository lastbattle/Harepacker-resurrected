...
namespace HaCreator.MapSimulator.Loaders
{
    public static partial class UIWindowLoader
    {
        ...
        {
            return CreateInventoryWindow(uiWindowImage, null, soundUIImage, device, screenWidth, screenHeight, runtimeServices);
        }
            ...
            IRuntimeDataServices runtimeServices)
        {
            ...
            if (itemProperty == null)
            {
                ...
                return CreatePlaceholderInventory(device, screenWidth, screenHeight, runtimeServices);
            }
            ...
            InventoryUI inventory = new InventoryUI(frame, null, device, runtimeServices);
        ...
        private static InventoryUI CreatePlaceholderInventory(
            ...
            IRuntimeDataServices runtimeServices)
        {
            ...
            {
                return CreateInventoryWindowBigBang(uiWindow2Image, uiWindow1Image, basicImage, soundUIImage, device, screenWidth, screenHeight, runtimeServices);
            }
            return CreateInventoryWindow(uiWindow1Image, basicImage, soundUIImage, device, screenWidth, screenHeight, runtimeServices);
        }
            ...
            IRuntimeDataServices runtimeServices)
        {
            ...
            if (itemProperty == null)
            {
                return CreatePlaceholderInventoryBigBang(device, screenWidth, screenHeight, runtimeServices);
            }
            ...
            InventoryUIBigBang inventory = new InventoryUIBigBang(frame, device, runtimeServices);
            ...
            UIObject tabCash = LoadInventoryCanvasTabButton(itemProperty, "4", btClickSound, btOverSound, device);
            inventory.InitializeTabs(tabEquip, tabUse, tabSetup, tabEtc, tabCash);
            SeedStarterCompanionInventory(inventory, device, runtimeAssets);
        ...
        private static InventoryUIBigBang CreatePlaceholderInventoryBigBang(
            GraphicsDevice device,
            int screenWidth,
            int screenHeight,
            IRuntimeDataServices runtimeServices)
