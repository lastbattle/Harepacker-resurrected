...
namespace HaCreator.MapSimulator
{
    public partial class MapSimulator
    {
        ...
        private void EnsureInitialQuizOwnerVisualsLoaded()
        {
            ...
            WzImage uiWindowImage = runtimeServices.Assets.FindImage("UI", "UIWindow.img");
            WzImage uiWindow2Image = runtimeServices.Assets.FindImage("UI", "UIWindow2.img") ?? uiWindowImage;
        ...
        private WzSubProperty ResolveInitialQuizOwnerOkButtonProperty(WzSubProperty preferred, WzSubProperty fallback)
        {
        ...
        private bool TryResolveInitialQuizOwnerUiSubPropertyPath(string resourcePath, out WzSubProperty property)
        {
            property = null;
            ...
            WzImage image = runtimeServices.Assets.FindImage("UI", imageName.Trim());
            property = image?[propertyPath.Trim()] as WzSubProperty;
            return property != null;
        }

        private WzCanvasProperty ResolveInitialQuizOwnerTimerDigitCanvas(int digit)
        {
            return ResolveInitialQuizOwnerCanvasFromStringPool(InitialQuizTimerDigitUolStringPoolId, digit);
        }

        private WzCanvasProperty ResolveInitialQuizOwnerCanvasFromStringPool(int stringPoolId, int? formatArgument = null)
        {
        ...
        private bool TryResolveInitialQuizOwnerUiCanvasPath(string resourcePath, out WzCanvasProperty canvas)
        {
            canvas = null;
            if (!TryDecodeInitialQuizOwnerUiResourcePath(resourcePath, out string imageName, out string propertyPath))
            {
