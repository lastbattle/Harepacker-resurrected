...
namespace HaCreator.MapSimulator
{
    ...
    {
        internal const string SessionUsage = "Usage: /guildboss session [status|verify|recent|discover <remotePort> [processName|pid] [localPort]|attach <remotePort> [processName|pid] [localPort]|attachproxy <listenPort|0> <remotePort> [processName|pid] [localPort]|start <listenPort|0> <serverHost> <serverPort>|startauto <listenPort|0> <remotePort> [processName|pid] [localPort]|stop]";
