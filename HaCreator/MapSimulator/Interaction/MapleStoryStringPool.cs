...
namespace HaCreator.MapSimulator.Interaction
{
    internal static partial class MapleStoryStringPool
    {
        ...
        private static readonly IReadOnlyDictionary<int, string> OverrideEntries = new Dictionary<int, string>
        {
            ...
            [0x11FE] = "(You do not have a Leader.)",
            [0x11FF] = "(You do not have an Senior.)",
            [0x1200] = "(You do not have a family yet.)",
            [0x1201] = "[Please add a Junior.]",
            [0x1202] = "%s Family",
            [0x1203] = "Senior(%d ppl.)",
            [0x1204] = "Junior(%d ppl.)",
            [0x1205] = "The name you entered is incorrect or he/she is currently not logged in.",
            [0x1206] = "You cannot add this character as a Junior.",
            [0x1207] = "You belong to the same family.",
            [0x1208] = "You do not belong to the same family.",
            [0x1209] = "The character you have entered does not exist.",
            [0x120A] = "The character you wish to add as\r\na Junior must be in the same map.",
            [0x120B] = "This character is already a Junior of another character.",
            [0x120C] = "The Junior you wish to add\r\nmust be at a lower rank.",
            [0x120D] = "The gap between you and your\r\njunior must be within 20 levels.",
            [0x120E] = "The Junior you wish to add\r\nmust be over Level 10.",
            [0x120F] = "Another character has requested to add this character.\r\nPlease try again later.",
            [0x1210] = "Another character has requested a summon.\r\nPlease try again later.",
            [0x1211] = "You can only use it when 6 Junior family members whose names can be confirmed on the Family Tree are logged in.",
            [0x1212] = "The summons has failed. Your current location or state does not allow a summons.",
            [0x1213] = "The family cannot extend more than 1000 generations from above and below.",
            [0x1214] = "You do not have room to add % as a Junior.",
            [0x1215] = "%s, you cannot add any more Juniors.",
            [0x1216] = "%s would like to\r\nbe your Senior. Would you like to be\r\n%s's Junior?",
            [0x1217] = "%s has declined your Junior request.",
            [0x1218] = "You have added %s as a Junior. Please do your best to guide the Junior in his/her game play.",
            [0x1219] = "%s has become your Senior. He/she will guide you in your game play.",
            [0x121A] = "%s has requested to sever ties, so your family relationship has ended.",
            [0x121B] = "You have severed ties with %s.\r\nYour family relationship has ended.",
            [0x121C] = "Your Rep has increased (%s, +%d)",
            [0x121D] = "You have used %d Rep Points.",
            [0x121E] = "%s has used '%s' Entitlement.",
            [0x121F] = "If you choose to sever ties with the selected character, everyone in your family will be affected. Would you like to proceed?",
            [0x1220] = "Please enter the name of the targeted family member.",
            [0x1221] = "From %s, %s has requested a summons. Would you like to transport?",
            [0x1222] = "%s has declined the summons request.",
            [0x1223] = "%s, you have exceed your Entitlement limit.",
            [0x1224] = "Reps are marked as [Current Rep/Total Rep].\r\nUse up your current Reps to acquire [Entitlements].",
            [0x1225] = "Juniors are marked as [Current Juniors/Max Juniors Available].\r\n When a Junior you have registered under gains EXP or levels up, your Rep will increase as well.\r\nHelp your Junior level up to further increase your Rep.",
            [0x1226] = "If the Junior slot is empty, then you can add a Junior that will help enhance your Rep.",
            [0x1227] = "Your Senior will sever ties and start a new family.\r\nThe members below you will belong to your family.",
            [0x1228] = "This will end your relationship with your Junior.\r\nThe Junior and everyone underneath will all be removed from the Family.",
            [0x1229] = "This covers everyone in the Family.\r\nThe number may be higher than the one shown in the Family Tree.",
            [0x122A] = "Entitlement used today: %d\r\nEntitlement available today: %d",
            [0x122B] = "You cannot use any more Entitlements today.",
            [0x122C] = "#c* You have surpassed your Senior's level, so your cumulative Rep#\r\n#cwill be reduced in half. Please help your Senior level up!#\r\n",
            [0x122D] = "#c* Your Junior has surpassed your level, so your cumulative Rep#\r\n#cwill be reduced in half. Please try harder to level up!#\r\n",
            [0x122E] = "Reps recorded to your Senior : %s\r\n",
            [0x122F] = "Entitlement in use :\r\n",
            ...
            [0x1070] = "[%s] The quest is in progress but it has not been registered in the alarm.",
