...
namespace HaCreator.MapSimulator.Character.Skills
{
    ...
    public class SkillManager
    {
        ...
        private bool ShouldSuppressDeferredMovingShootExecution(SkillData skill, int currentTime)
        {
            ...
            return liveWorldPosition == _lastDeferredMovingShootExecution.LiveWorldPosition;
        }
        ...
        private void UpdateRocketBooster(int currentTime)
        {
            ...
            if (!_rocketBoosterState.RecoveryEffectRequested
                && currentTime - _rocketBoosterState.LandingAttackTime >= ROCKET_BOOSTER_LANDING_RECOVERY_MS)
            {
