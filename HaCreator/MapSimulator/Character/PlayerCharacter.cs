...
namespace HaCreator.MapSimulator.Character
{
    ...
    public class PlayerCharacter
    {
        ...
        private void ProcessInput(int currentTime, float deltaTime)
        {
            ...
            else
            {
                ...
                if (!_physicsDebugLogged && (_inputLeft || _inputRight))
                {
                    ...
                    System.Diagnostics.Debug.WriteLine($"[PlayerCharacter Physics] accel={walkForce/entityMass:F1} px/s„Éª„ÇëÔΩΩÅE≤, decel={walkDrag/entityMass:F1} px/s„Éª„ÇëÔΩΩÅE≤");
                }
        ...
        internal static IReadOnlyList<MirrorImagePreparedLayerNativeOperation> BuildMirrorImagePreparedLayerNativeOperations(
            ...
            int relMoveEndTime)
        {
            var operations = new List<MirrorImagePreparedLayerNativeOperation>(24);
            int sequence = 0;
