...
namespace HaCreator.MapSimulator.Entities
{
    internal static class MobAngerGaugeBurstParity
    {
            ...
            int currentTick)
        {
            return new MobAngerGaugeFullChargeCallerTrace(
                ...
                UsesNativeSignedCurrentTickComparison: true,
                FormatsTemplatePathWithSecureTemplateId: true,
                AllowsNullTemplatePathFormatPointer: true,
                RequiresEffectNameStringBeforeAppend: true,
                ...
                RetainsOverlayParentBeforeOrigin: true,
                CopiesSourceUolAfterRetainingParentAndOrigin: true,
                ReleasesSourceUolAfterDisplayerCall: true,
    ...
    internal readonly record struct MobAngerGaugeFullChargeCallerTrace(
        ...
        bool UsesNativeSignedCurrentTickComparison,
        bool FormatsTemplatePathWithSecureTemplateId,
        bool AllowsNullTemplatePathFormatPointer,
        bool RequiresEffectNameStringBeforeAppend,
        ...
        bool RetainsOverlayParentBeforeOrigin,
        bool CopiesSourceUolAfterRetainingParentAndOrigin,
        bool ReleasesSourceUolAfterDisplayerCall,
