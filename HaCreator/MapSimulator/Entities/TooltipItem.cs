...
namespace HaCreator.MapSimulator.Entities
{
    ...
    {
        private readonly ToolTipInstance _tooltipInstance;
        public ToolTipInstance TooltipInstance
        {
            get { return this._tooltipInstance;  }
            private set { }
        }

        public TooltipItem(ToolTipInstance _tooltipInstance, List<IDXObject> frames)
            : base(frames, false)
        {
            this._tooltipInstance = _tooltipInstance;
        }
        ...
        public TooltipItem(ToolTipInstance npcInstance, IDXObject frame0)
            : base(frame0, false)
        {
            this._tooltipInstance = npcInstance;
        }
