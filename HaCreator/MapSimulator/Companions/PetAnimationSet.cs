    ...
    internal static class PetActionAliases
    {
        ...
        private static readonly IReadOnlyDictionary<string, string[]> LookupCandidates =
            new Dictionary<string, string[]>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["move"] = new[] { "move", "move1", "move2", "walk", "go" },
                ["move1"] = new[] { "move1", "move2", "move", "walk", "go" },
                ["move2"] = new[] { "move2", "move1", "move", "walk", "go" },
                ["walk"] = new[] { "walk", "move", "move1", "move2", "go" },
                ["go"] = new[] { "go", "move", "move1", "move2", "walk" },
                ...
                ["warn"] = new[] { "warn", "irrelevant", "alert", "eye", "birdeye", "hand" },
                ["hand"] = new[] { "hand", "hands", "alert" },
                ["hands"] = new[] { "hands", "hand", "alert" },
                ["stretch"] = new[] { "stretch", "love" },
                ["love"] = new[] { "love", "love2", "stretch" },
                ["love2"] = new[] { "love2", "love", "stretch" },
                ...
                ["irrelevant"] = new[] { "irrelevant", "warn", "ignore", "hide", "upset", "nothing", "sulk", "puling", "bewildered" },
                ...
                ["shock"] = new[] { "shock", "flash", "surprise", "panic", "stunned", "alert" },
                ["flash"] = new[] { "flash", "shock", "surprise", "panic", "stunned", "alert" },
                ...
                ["dance"] = new[] { "dance", "dancing", "play", "charming", "glitter", "happy", "love" },
                ["dancing"] = new[] { "dancing", "dance", "play", "charming", "glitter", "happy", "love" },
                ["sneer"] = new[] { "sneer", "arrogance", "angry", "cry", "no" },
                ["hug"] = new[] { "hug", "huk", "hul", "love" },
                ...
                ["charm"] = new[] { "charm", "charming", "cute", "love", "happy" },
                ["glitter"] = new[] { "glitter", "dance", "christmas", "love" },
                ["twinkling"] = new[] { "twinkling", "christmas", "glitter", "shock", "surprise", "happy", "love" },
                ["cute"] = new[] { "cute", "love", "happy", "smile", "charming" },
                ["christmas"] = new[] { "christmas", "twinkling", "glitter", "love", "happy", "cute" },
                ["fart"] = new[] { "fart" },
                ...
                ["hul"] = new[] { "hul", "huk", "hug", "surprise", "panic", "stunned", "alert" },
                ["huk"] = new[] { "huk", "hul", "hug", "surprise", "panic", "stunned", "alert" },
                ["buff"] = new[] { "buff", "heal", "transform", "transformaction" },
                ["heal"] = new[] { "heal", "buff", "transform", "transformaction" },
                ["arrogance"] = new[] { "arrogance", "sneer", "ignore", "angry", "no", "tedious" },
                ["start"] = new[] { "start", "star", "rise", "stand0", "stand1", "stand" },
                ["star"] = new[] { "star", "start", "rise", "stand0", "stand1", "stand" },
