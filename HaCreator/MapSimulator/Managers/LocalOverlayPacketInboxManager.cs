...
namespace HaCreator.MapSimulator.Managers
{
    ...
    public sealed class LocalOverlayPacketInboxManager : IDisposable
    {
        ...
        public const int NotifyHpDecByFieldClientPacketType = 243;
        public const int BalloonMsgClientPacketType = 245;
        public const int DamageMeterClientPacketType = 267;
        ...
        public static bool TryParsePacketType(string token, out int packetType)
        {
            ...
            if (string.Equals(normalized, "hpdec", StringComparison.OrdinalIgnoreCase)
                || string.Equals(normalized, "fieldhazard", StringComparison.OrdinalIgnoreCase)
            ...
            if (string.Equals(normalized, "hazardresult", StringComparison.OrdinalIgnoreCase)
                || string.Equals(normalized, "petconsume", StringComparison.OrdinalIgnoreCase)
                || string.Equals(normalized, "petconsumeresult", StringComparison.OrdinalIgnoreCase))
            {
