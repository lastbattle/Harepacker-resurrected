...
namespace HaCreator.MapSimulator
{
    ...
    {
        internal const string SessionUsage = "Usage: /coconut session [status|recent|discover <remotePort> [processName|pid] [localPort]|attach <remotePort> [processName|pid] [localPort]|attachproxy <listenPort|0> <remotePort> [processName|pid] [localPort]|start <listenPort|0> <serverHost> <serverPort>|startauto <listenPort|0> <remotePort> [processName|pid] [localPort]|stop]";
        internal const string StartUsage = "Usage: /coconut session start <listenPort|0> <serverHost> <serverPort>";
        internal const string AttachProxyUsage = "Usage: /coconut session attachproxy <listenPort|0> <remotePort> [processName|pid] [localPort]";
