...
namespace HaCreator.MapSimulator.Pools
{
    ...
    public static class RemoteUserPacketCodec
    {
        ...
        private static readonly HashSet<string> KnownDefaultHelperAncillaryMarkerNames = new(StringComparer.Ordinal)
        {
            "npc",
            "startnpc",
            "endnpc",
        ...
        public static bool TryParseThrowGrenade(ReadOnlySpan<byte> payload, out RemoteUserThrowGrenadePacket packet, out string error)
        {
            ...
            try
            {
                ...
                packet = new RemoteUserThrowGrenadePacket(characterId, x, y, keyDownTime, skillId, skillLevel);
                return true;
            }
            catch (InvalidOperationException ex)
            {
            ...
            try
            {
                ...
                if (!chargeSkillId.HasValue
                    && TryResolveChargeSkillIdFromKnownTemporaryStatPayload(
                        ...
                        preferredSkillId: 0,
                        weaponChargeValue: decodedWeaponChargeValue,
