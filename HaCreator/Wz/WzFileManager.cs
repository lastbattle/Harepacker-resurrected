...
namespace HaCreator.Wz
{
    ...
    {
        #region Constants
        public static string[] MOB_WZ_FILES = {
            "Mob", "Mob001", "Mob002",
        };

        public static string[] MAP_WZ_FILES = {
            "Map", "Map001", "Map002", //kms now stores main map key here
            "Map2"
        };

        public static string[] SOUND_WZ_FILES = {
            "Sound", "Sound001", "Sound2",
            "Sound002"
        };
        ...
        public void ExtractBackgroundSets()
        {
            if (Initialization.isClient64())
            {
                foreach (string back in BACK_WZ_FILES_64)
                {
                    WzDirectory bgParent1 = (WzDirectory)this[back];
                    if (bgParent1 != null)
                    {
