...
namespace HaCreator.MapEditor.Instance.Shapes
{
    public abstract class MapleDot : BoardItem, ISnappable
    {
        ...
        {
            // Show foothold connection targets clearly while drawing. Keep other
            // unselected structural handles subdued in normal editing.
            if (!Selected && !(this is FootholdAnchor && Board.Mouse.State == MouseState.Footholds))
                color *= 0.24f;
