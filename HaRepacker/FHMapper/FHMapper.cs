    ...
    public class FHMapper
    {
        ...
        private Bitmap RenderMinimap(Size bmpSize, WzFile wzFile, WzImage img, string mapIdName, WzSubProperty miniMapSubProperty)
        {
            ...
            using (Graphics drawBuf = Graphics.FromImage(minimapRender))
            {
                ...
                WzImage mapNameImages = (WzImage)WzFile.GetObjectFromMultipleWzFilePath(mapNameStringPath, MainPanel.MainForm.WzFileListReadOnly);
        ...
        public bool TryRenderMapAndSave(WzImage img, double zoom, ref List<string> errorList)
        {
                        ...
                        case "m": // monster
                            {
                                ...
                                WzStringProperty linkInfo = (WzStringProperty)WzFile.GetObjectFromMultipleWzFilePath(mobWzPath, MainPanel.MainForm.WzFileListReadOnly);
                                if (linkInfo != null)
                                {
                                ...
                                WzCanvasProperty lifeImg = (WzCanvasProperty)WzFile.GetObjectFromMultipleWzFilePath(mobLinkWzPath, MainPanel.MainForm.WzFileListReadOnly);
                                if (lifeImg != null)
                                {
                                ...
                                // Get monster name
                                WzStringProperty stringName = (WzStringProperty)WzFile.GetObjectFromMultipleWzFilePath(mobNamePath, MainPanel.MainForm.WzFileListReadOnly);
                                if (stringName != null)
            ...
            using (Graphics tileBuf = Graphics.FromImage(backgroundRender))
            {
                ...
                if (backImg != null)
                {
                    foreach (WzSubProperty bgItem in backImg.WzProperties)
                    {
                        ...
                        WzCanvasProperty wzBgCanvas = (WzCanvasProperty)WzFile.GetObjectFromMultipleWzFilePath(bgObjImagePath, MainPanel.MainForm.WzFileListReadOnly);
                        if (wzBgCanvas != null)
                        {
            ...
            if (tooltipProperty != null)
            {
                ...
                using (Graphics toolTipBuf = Graphics.FromImage(toolTip))
                {
                    ...
                    WzSubProperty wzToolTip = (WzSubProperty)WzFile.GetObjectFromMultipleWzFilePath(stringTooltipPath, MainPanel.MainForm.WzFileListReadOnly);
                ...
                for (int i = 0; i < 7; i++)
                {
                    ...
                    if (objProperties.WzProperties.Count > 0)
                    {
                        foreach (WzSubProperty obj in objProperties.WzProperties)
                        {
                            ...
                            WzImageProperty objData = (WzImageProperty)WzFile.GetObjectFromMultipleWzFilePath(imgObjPath, MainPanel.MainForm.WzFileListReadOnly);
                            tryagain:
                    ...
                    WzImage tileSet = (WzImage)WzFile.GetObjectFromMultipleWzFilePath(tilePath, MainPanel.MainForm.WzFileListReadOnly);
                    if (!tileSet.Parsed)
                        tileSet.ParseImage();
